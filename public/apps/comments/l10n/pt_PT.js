OC.L10N.register(
    ...
    "Error occurred while updating comment with id {id}" : "Ocorreu um erro ao tentar atualizar o comentário com a id. {id}",
    "Error occurred while posting comment" : "Ocorreu um erro ao publicar o comentário",
