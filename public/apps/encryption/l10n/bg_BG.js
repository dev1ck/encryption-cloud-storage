OC.L10N.register(
    ...
    "Encryption type: Master Key" : "Тип кодиране: Master Key",
    "Encryption type: User Specific Key" : "Тип кодиране: User Specific Key",
    "Please select an encryption option" : "Моля, изберете опция за криптиране",
    "Master Key" : "Master Key",
    "User-specific key" : "User-specific key",
    "Permanently select this mode" : "Избор за постоянно на този режим",
