OC.L10N.register(
    "encryption",
    {
    "Missing recovery key password" : "Λείπει το κλειδί ανάκτησης κωδικού",
    "Please repeat the recovery key password" : "Παρακαλούμε επαναλάβετε το κλειδί ανάκτησης κωδικού",
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "Είναι ενεργοποιημένη η εφαρμογή κρυπτογράφησης, αλλά τα κλειδιά σας δεν έχουν καταγραφεί. Παρακαλώ αποσυνδεθείτε και επανασυνδεθείτε.",
    "Encryption App is enabled and ready" : "Η Εφαρμογή Κρυπτογράφησης είναι ενεργοποιημένη και έτοιμη.",
    "Bad Signature" : "Κακή υπογραφή",
    "Missing Signature" : "Λείπει η υπογραφή",
    ...
    "Encryption type: Master Key" : "Τύπος κρυπτογράφησης: Βασικό κλειδί",
