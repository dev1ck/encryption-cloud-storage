OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "La app de cifrado está habilitada pero las claves no se han inicializado, por favor, cierre la sesión y vuelva a iniciarla de nuevo.",
    ...
    "Default encryption module" : "Modulo de cifrado por defecto",
    ...
    "Encryption type: Master Key" : "Tipo de cifrado: Clave maestra",
    "Encryption type: User Specific Key" : "Tipo de cifrado: Cave de usuario",
    "Please select an encryption option" : "Por favor seleccione una opción",
    "Master Key" : "Clave maestra",
    "User-specific key" : "Clave de Usuario",
    "Permanently select this mode" : "Seleccionar este metodo por defecto",
