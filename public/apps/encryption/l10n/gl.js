OC.L10N.register(
    ...
    "Recovery key successfully enabled" : "Activada satisfactoriamente a clave de recuperación",
    ...
    "Recovery key successfully disabled" : "Desactivada satisfactoriamente a clave de recuperación",
    ...
    "Please provide a new recovery password" : "Introduza a nova clave de recuperación",
    ...
    "Recovery Key enabled" : "Activada a clave de recuperación",
    ...
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one. Please run 'occ encryption:migrate' or contact your administrator" : "É necesario migrar as súas claves de cifrado do antigo cifrado (ownCloud <= 8,0) cara ao novo. Execute «occ encryption:migrate» ou contacte co administrador",
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "A aplicación de cifrado está activada mais as clave non foron preparadas, saia da sesión e volva a acceder de novo",
    ...
    "Hey there,\n\nthe admin enabled server-side-encryption. Your files were encrypted using the password '%s'.\n\nPlease login to the web interface, go to the section 'ownCloud basic encryption module' of your personal settings and update your encryption password by entering this password into the 'old log-in password' field and your current login-password.\n\n" : "Ola,\n\nO administrador activou o cifrado do lado do servidor. Os seus ficheiros cifraránse co contrasinal «%s».\n\nIdentifíquese na interface web, vaia á sección «Módulo básico de cifrado do ownCloud» dos seus axustes personais e actualice o seu contrasinal escribindo este contrasinal no campo «Contrasinal antigo de acceso» e introducindo a nova no seu correspondente campo.\n\n",
    "The share will expire on %s." : "Esta compartición caduca o %s.",
    "Cheers!" : "Saúdos!",
    "Hey there,<br><br>the admin enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>.<br><br>Please login to the web interface, go to the section \"ownCloud basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.<br><br>" : "Ola,<br><br>O administrador activou o cifrado do lado do servidor. Os seus ficheiros cifraránse co contrasinal <strong>%s</strong>.<br><br>Identifíquese na interface web, vaia á sección «Módulo básico de cifrado do ownCloud» dos seus axustes personais e actualice o seu contrasinal escribindo este contrasinal no campo «Contrasinal antigo de acceso» e introducindo a nova no seu correspondente campo.<br><br>",
    "Default encryption module" : "Modulo predeterminado de cifrado",
    ...
    "Encryption type: Master Key" : "Tipo de cifrado: Clave mestra",
