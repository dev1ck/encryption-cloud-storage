OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "יישום הצפנה מופעל, אבל המפתחות שלך לא אותחלו, יש להתנתק ולהתחבר מחדש.",
    ...
    "Default encryption module" : "מודול הצפנה ברירת מחדל",
    ...
    "Encryption type: Master Key" : "סוג הצפנה: מפתח ראשי",
    "Encryption type: User Specific Key" : "סוג הצפנה: מפתח משתמש ספציפי",
    "Please select an encryption option" : "יש לבחור סוג הצפנה",
    "Master Key" : "מפתח ראשי",
    "User-specific key" : "מפתח משתמש ספציפי",
