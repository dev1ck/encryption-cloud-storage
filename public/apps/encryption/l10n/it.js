OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "L'App Encryption è abilitata, ma le tue chiavi non sono inizializzate, Per favore effettua il log-out e accedi nuovamente.",
    ...
    "Default encryption module" : "Modulo predefinito di crittografazione",
    "Encryption App is enabled but your keys are not initialized, please log-out and log-in again" : "L'applicazione di cifratura è abilitata, ma le chiavi non sono state inizializzate, disconnettiti ed effettua nuovamente l'accesso",
    "Encryption type: Master Key" : "Tipo di crittografazione: Chiave Principale",
    "Encryption type: User Specific Key" : "Tipo di crittografazione: Chiave specifica dell'Utente",
    "Please select an encryption option" : "Scegliere un tipo di crittografazione.",
    "Master Key" : "Chiave principale",
    "User-specific key" : "Chiave definita dall'utente",
