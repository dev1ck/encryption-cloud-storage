OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one. Please run 'occ encryption:migrate' or contact your administrator" : "Należy dokonać migracji kluczy szyfrujących ze starej wersji (ownCloud <= 8.0) do nowej. Uruchom 'occ encryption:migrate' lub skontaktuj się z administratorem",
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "Aplikacja Szyfrowanie jest włączona, ale klucze nie zostały wygenerowane. Wyloguj się i zaloguj ponownie.",
    "Encryption App is enabled and ready" : "Aplikacja szyfrowania jest włączona i gotowa do pracy",
    "Bad Signature" : "Niewłaściwy podpis",
    "Missing Signature" : "Brakujący podpis",
    "one-time password for server-side-encryption" : "hasło jednorazowe dla szyfrowania po stronie serwera ",
    ...
    "Can not read this file, probably this is a shared file. Please ask the file owner to reshare the file with you." : "Nie można odczytać pliku; prawdopodobnie jest to plik współdzielony. Poroś właściciela pliku o jego ponowne udostępnienie.",
    ...
    "Encryption type: Master Key" : "Rodzaj szyfrowania: Klucz główny",
    "Encryption type: User Specific Key" : "Rodzaj szyfrowania: Klucz użytkownika",
    "Please select an encryption option" : "Zaznacz opcję szyfrowania",
    "Master Key" : "Główny klucz",
    "User-specific key" : "Klucz użytkownika",
    ...
    "The recovery key is an extra encryption key that is used to encrypt files. It allows recovery of a user's files if the user forgets his or her password." : "Klucz odzyskiwania to dodatkowy klucz szyfrujący używany szyfrowania plików. Pozwala na odzyskanie plików użytkownika w przypadku zapomnienia hasła.",
    ...
    "ownCloud basic encryption module" : "Podstawowy moduł szyfrowania ownCloud",
