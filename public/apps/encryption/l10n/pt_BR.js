OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "Criptografia do App está habilitada mas suas chaves não foram inicializadas. Por favor, desconecte-se e autentique-se novamente.",
    ...
    "Encryption type: Master Key" : "Tipo de criptografia: Chave Mestra",
    "Encryption type: User Specific Key" : "Tipo de criptografia: Chave específica do usuário",
    "Please select an encryption option" : "Selecione uma opção de criptografia",
    "Master Key" : "Chave Mestra",
    "User-specific key" : "Chave específica do usuário",
