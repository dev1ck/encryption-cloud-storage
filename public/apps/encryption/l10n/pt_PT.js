OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "A Aplicação de Encriptação está ativada, mas as suas chaves não estão inicializadas. Por favor, termine a sessão e inicie-a novamente.",
    ...
    "Default encryption module" : "Módulo de encriptação padrão",
    "Encryption App is enabled but your keys are not initialized, please log-out and log-in again" : "A Aplicação de Encriptação está ativada, mas as suas chaves não estão inicializadas. Por favor, termine a sessão e inicie-a novamente",
    "Encryption type: Master Key" : "Tipo de encriptação: Chave-mestra",
    "Encryption type: User Specific Key" : "Tipo de encriptação: Chave escolhida pelo utilizador",
    "Please select an encryption option" : "Por favor selecione uma opção de encriptação",
    "Master Key" : "Chave-mestra",
    "User-specific key" : "Chave escolhida pelo utilizador",
    "Permanently select this mode" : "Selecionar este modo permanentemente",
