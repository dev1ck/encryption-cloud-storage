OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "Şifreleme Uygulaması etkin, fakat anahtarlarınız hazırlanmamış. Lütfen oturumu kapatıp yeniden açın.",
    ...
    "Default encryption module" : "Öntanımlı şifreleme modülü",
    "Encryption App is enabled but your keys are not initialized, please log-out and log-in again" : "Şifreleme Uygulaması etkin, fakat anahtarlarınız hazırlanmamış. Lütfen oturumu kapatıp yeniden açın.",
    "Encryption type: Master Key" : "Şifreleme türü: Ana Anahtar",
    "Encryption type: User Specific Key" : "Şifreleme türü: Kullanıcıya Özel Anahtar",
    "Please select an encryption option" : "Lütfen bir şifreleme opsiyonu seçiniz",
    "Master Key" : "Ana Anahtar",
    "User-specific key" : "Kullanıcıya özel anahtar",
