OC.L10N.register(
    ...
    "Encryption App is enabled, but your keys are not initialized. Please log-out and log-in again." : "加密軟體已啟用但是您的密鑰尚未初始化。 請註銷記錄並再次登錄記錄。",
    ...
    "Encryption type: Master Key" : "加密類型：萬能鑰匙",
    "Encryption type: User Specific Key" : "加密類型：使用者專用密鑰",
    "Please select an encryption option" : "請選擇一個加密選項",
    "Master Key" : "主密鑰",
    "User-specific key" : "使用者專用密鑰",
    "Permanently select this mode" : "永久選擇此模式",
