OC.L10N.register(
    ...
    "Unknown error \"{error}\" uploading file \"{file}\"" : "Неизвестна грешка \"{error}\" при качването на файл \"{file}\"",
    ...
    "The file {file} is currently locked, please try again later" : "Файлът {file} е заключен, моля опитайте отново по-късно",
    ...
    "Could not move \"{file}\": {message}" : "Не може да се премести \"{file}\": {message}",
    ...
    "Lock status" : "Състояние заключен",
    "This resource is locked. Click to see more details." : "Този ресурс е заключен. Кликнете, за да видите повече подробности.",
    ...
    "\"{name}\" has a forbidden file type/extension." : "\"{name}\" има забранен тип/разширение на файла.",
    ...
    "Could not unlock, please contact the lock owner {owner}" : "Не може да се отключи, моля свържете се със собственика на ключа {owner}",
