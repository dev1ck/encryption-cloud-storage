OC.L10N.register(
    ...
    "Could not move \"{file}\" because either the file or the target are locked." : "Die Datei \"{file}\" konnte nicht verschoben werden, weil die Datei oder das Ziel gesperrt sind.",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "Die Datei {file} ist zur Zeit gesperrt, bitte versuchen Sie es später noch einmal",
    ...
    "Encountered problem accessing the folder {name}" : "Problem beim Zugriff auf den Ordner {name} aufgetreten",
