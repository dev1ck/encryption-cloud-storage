OC.L10N.register(
    ...
    "Unknown error \"{error}\" uploading file \"{file}\"" : "Erreur inconnue \"[error}\" lors du téléversement du fichier \"{file}\"",
    "Could not create folder \"{dir}\"" : "Impossible de créer le dossier \"{dir}\"",
    "Upload cancelled." : "Envoi annulé.",
    "The file {file} already exists" : "Le fichier [fichier] existe déjà",
    ...
    "The file {file} is currently locked, please try again later" : "Le fichier [fichier] est actuellement bloqué, veuillez réessayer plus tard ",
    ...
    "This resource is locked. Click to see more details." : "cette ressource est vérouillée, cliquer pour plus de détails",
    "\"{name}\" is an invalid file name." : "\"{name}\" n'est pas un nom de fichier valide.",
    "File name cannot be empty." : "Le nom de fichier ne peut être vide.",
    "File name cannot contain \"/\"." : "Le nom du fichier ne peut pas comporter le caractère \"/\".",
    "\"{name}\" has a forbidden file type/extension." : "Le type de fichier/l'extension de \"{name}\" est incorrect/e.",
    ...
    "Unlock failed with status {status}" : "Le déverrouillage a échoué avec l'état {status}",
    "Locks" : "Verrouiller",
    "Resource is not locked" : "La ressource n'est pas verrouillée",
    "Path" : "Chemin",
