OC.L10N.register(
    ...
    "Unknown error \"{error}\" uploading file \"{file}\"" : "Ismeretlen hiba \"{error}\" az állomány feltöltése közben \"{file}\"",
    "Could not create folder \"{dir}\"" : "{dir} könyvtár nem létrehozható",
    "Upload cancelled." : "A feltöltést megszakítottuk.",
    "Processing files..." : "Állományok feldolgozása...",
    ...
    "Target folder \"{dir}\" does not exist any more" : "A cél mappa \"{dir}\" nem létezik már",
    "Target folder does not exist any more" : "A cél mappa nem létezik már",
    "Not enough free space" : "Nincs elég szabad hely",
    "Uploading..." : "Feltöltés...",
    "..." : "...",
    "{loadedSize} of {totalSize} ({bitrate})" : "({bitrate}) {totalSize} -nak a {loadedSize} ",
    "Error when assembling chunks, status code {status}" : "Hiba lépett fel a darabok összeállítása közben, státusz kód {status}",
    ...
    "Could not load info for file \"{file}\"" : "Nem sikerült az állomány információinak betöltése \"{file}\"",
    "Files" : "Fájlkezelő",
    "Details" : "Részletek",
    "Select" : "Kiválaszt",
    "Pending" : "Folyamatban",
    ...
    "No entries in this folder match {filter}" : "Nincsenek elemek, ebben a mappa összehasonlításban {filter}",
    "Name" : "Név",
    "Size" : "Méret",
    "Modified" : "Módosítva",
    ...
    "_including %n hidden_::_including %n hidden_" : ["beleértve %n rejtettet","beleértve %n rejtettet"],
    ...
    "\"{name}\" has a forbidden file type/extension." : "\"{name}\" meg lett tagadva a fájl-kiterjesztése miatt.",
    ...
    "You don't have permissions to access this file/folder - Please contact the owner to share it with you." : "Önnek nincsen engedélye, hogy hozzáférjen ehhez a fájlhoz/mappához - Kérjük, hogy vegye fel a kapcsolatot a tulajdonossal, hogy azt megossza Önnel.",
