OC.L10N.register(
    ...
    "Close" : "Chiudi",
    "Favorites" : "Preferiti",
    "Upload timeout for file \"{file}\"" : "Tempo terminato per il file \"{file}\"",
    "Unknown error \"{error}\" uploading file \"{file}\"" : "Errore sconosciuto \"{error}\" inviando il file \"{file}\"",
    ...
    "Processing files..." : "Sto processando i file...",
    ...
    "Error when assembling chunks, status code {status}" : "Errore assemblando le parti, codice di stato {status}",
    ...
    "Could not move \"{file}\": {message}" : "Non posso muovere il file \"{file}\": {message}",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "Il file \"{fileName}\" è bloccato e non può essere rinominato.",
    ...
    "The file \"{fileName}\" is locked and cannot be deleted." : "Il file \"{fileName}\" è bloccato e non può essere eliminato.",
    "Error deleting file \"{fileName}\"." : "Errore durante l'eliminazione del file \"{fileName}\".",
    "No entries in this folder match {filter}" : "Nessuna file in questa cartella risponde a {filter}",
    "Name" : "Nome",
    "Size" : "Dimensione",
    "Modified" : "Modificato",
    ...
    "This resource is locked. Click to see more details." : "Questa risorsa è bloccata. Clicca per maggiori dettagli.",
    ...
    "\"{name}\" has a forbidden file type/extension." : "\"{name}\" ha  un tipo di file/estensione vietato",
    ...
    "{owner} has locked this resource via {path}" : "{owner} ha bloccato questa risorsa via {path}",
    "Could not unlock, please contact the lock owner {owner}" : "Impossibile sbloccare, contatta il proprietario del blocco {owner}",
    "Unlock failed with status {status}" : "Sblocco fallito con stato {status}",
    "Locks" : "Blocchi",
    "Resource is not locked" : "La risorsa non è bloccata",
    "Path" : "Percorso",
    "_%n byte_::_%n bytes_" : ["%n byte","%n byte"],
    "Favorited" : "Preferiti",
    "Favorite" : "Preferito",
    "Private link:  Only people who have access to the file/folder can use it. Use it as a permanent link for yourself or to point others to files within shares" : "Collegamento Privato: Solo le persone che hanno accesso a questo file/cartella possono utilizzarlo.\nUtilizzalo come un collegamento permanente per te. Oppure, dentro una condivisione, per puntare a quei file.",
    "Folder" : "Cartella",
    ...
    "You don't have permissions to access this file/folder - Please contact the owner to share it with you." : "Non hai il permeso di accedere a questo file/cartella - contatta il proprietario che lo ha condiviso con te.",
