OC.L10N.register(
    ...
    "Unknown error \"{error}\" uploading file \"{file}\"" : "\"{file}\" 파일 업로드 중 알 수 없는 오류 \"{error}\" 발생",
    ...
    "\"{name}\" has a forbidden file type/extension." : "\"{name}\"의 확장자나 형식이 금지되어 있습니다.",
    ...
    "Favorited" : "즐겨찾기에 추가됨",
    "Favorite" : "즐겨찾기",
    "Private link:  Only people who have access to the file/folder can use it. Use it as a permanent link for yourself or to point others to files within shares" : "개인 링크: 파일이나 폴더에 접근할 수 있는 사람만 사용할 수 있습니다. 나 자신을 위한 고유 링크 및 다른 사람들에게 공유한 파일 주소를 알려 줄 때 사용할 수 있습니다",
    "Folder" : "폴더",
    "New folder" : "새 폴더",
