OC.L10N.register(
    ...
    "The file {file} already exists" : "Het bestand {file} bestaat alreeds",
    ...
    "The file {file} is currently locked, please try again later" : "Het bestand {file} is momenteel gelockt, probeer het later opnieuw",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "Het bestand \"{fileName}\" is gelockt en kan niet worden hernoemt.",
    ...
    "The file \"{fileName}\" is locked and cannot be deleted." : "Het bestand \"{fileName}\" is gelockt en kan niet worden verwijderd.",
    ...
    "This resource is locked. Click to see more details." : "Deze resource is gelockt. Klik hier voor meer details.",
    "\"{name}\" is an invalid file name." : "\"{name}\" is een ongeldige bestandsnaam.",
    "File name cannot be empty." : "Bestandsnaam kan niet leeg zijn.",
    "File name cannot contain \"/\"." : "Bestandsnaam mag niet \"/\" bevatten",
    ...
    "{owner} has locked this resource via {path}" : "{owner} heeft dit item gelockt via {path}",
    "Unlock" : "ontgrendel",
    "Unlock failed with status {status}" : "Unlock mislukt met status {status}",
    "Path" : "Pad",
    ...
    "You don't have permissions to access this file/folder - Please contact the owner to share it with you." : "U heeft geen toegang tot dit bestand / map. Neem contact op met de eigenaar om het met u te delen.",
