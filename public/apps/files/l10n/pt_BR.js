OC.L10N.register(
    ...
    "How do you want to open this file?" : "Como você deseja abrir este arquivo?",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "O arquivo \"{fileName}\" está bloqueado e não pode ser renomeado.",
    ...
    "The file \"{fileName}\" is locked and cannot be deleted." : "O arquivo \"{fileName}\" está bloqueado e não pode ser excluído.",
    ...
    "{owner} has locked this resource via {path}" : "{owner} bloqueou este recurso via {path}",
    "Unlock" : "Desbloquear",
