OC.L10N.register(
    ...
    "Target folder \"{dir}\" does not exist any more" : "Целевой каталог \"{dir}\" больше не существует",
    ...
    "Not enough free space" : "Не хватает свободного места",
    "Uploading..." : "Загрузка...",
    "..." : "...",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "Файл \"{fileName}\" заблокирован, его невозможно переименовать.",
    ...
    "The file \"{fileName}\" is locked and cannot be deleted." : "Файл \"{fileName}\" заблокирован, его невозможно удалить.",
    "Error deleting file \"{fileName}\"." : "Ошибка удаления файла \"{fileName}\".",
    "No entries in this folder match {filter}" : "Никакие элементы в этом каталоге не соответствуют {filter}",
    "Name" : "Имя",
    "Size" : "Размер",
    "Modified" : "Изменён",
    ...
    "Encountered problem accessing the folder {name}" : "Обнаружена проблема с доступом к папке {name}",
    "\"{name}\" is an invalid file name." : "\"{name}\" это неправильное имя файла.",
    "File name cannot be empty." : "Имя файла не может быть пустым.",
    "File name cannot contain \"/\"." : "Имя файла не может содержать символ \"/\".",
    "\"{name}\" has a forbidden file type/extension." : "У «{name}» запрещённый тип/расширение файла.",
