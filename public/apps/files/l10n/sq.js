OC.L10N.register(
    ...
    "Lock file" : "Kyçe kartelën",
    "Failed to lock." : "S’u arrit të kyçej.",
    "This resource is locked. Click to see more details." : "Ky burim është i kyçur. Klikoni për të parë më tepër hollësi.",
    "Encountered problem accessing the folder {name}" : "U has problem në hyrjen te dosja {name}",
    ...
    "Storage of {owner} is almost full ({usedSpacePercent}%)" : "Depozita e {owner} është thuajse plot ({usedSpacePercent}%)",
