OC.L10N.register(
    ...
    "Upload timeout for file \"{file}\"" : "หมดเวลาสำหรับการอัปโหลดสำหรับไฟล์ \"{file}\"",
    ...
    "File upload is in progress. Leaving the page now will cancel the upload." : "การอัปโหลดไฟล์กำลังอยู่ในระหว่างดำเนินการ การออกจากหน้าเว็บนี้จะทำให้การอัปโหลดถูกยกเลิก",
    "Actions" : "การกระทำ",
    "Download" : "ดาวน์โหลด",
    "Rename" : "เปลี่ยนชื่อ",
    "Delete" : "ลบ",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "ไฟล์ \"{fileName}\" ถูกล็อคอยู่จึงไม่สามารถเปลี่ยนชื่อได้",
    ...
    "The file \"{fileName}\" is locked and cannot be deleted." : "ไฟล์ \"{fileName}\" ถูกล็อคอยู่จึงไม่สามารถลบได้",
    ...
    "Size" : "ขนาด",
    "Modified" : "แก้ไขเมื่อ",
    "_%n folder_::_%n folders_" : ["เลือกแล้ว %n โฟลเดอร์"],
    ...
    "_Uploading %n file_::_Uploading %n files_" : ["อัปโหลด %n ไฟล์"],
    "New" : "ใหม่",
    ...
    "\"{name}\" has a forbidden file type/extension." : "\"{name}\" ไม่อนุญาตให้ใช้งานนามสกุลไฟล์นี้",
    "Storage of {owner} is full, files can not be updated or synced anymore!" : "พื้นที่จัดเก็บข้อมูลของ {owner} เต็มแล้ว  ไฟล์ไม่สามารถอัปเดตหรือประสานข้อมูลได้อีก!",
    "Your storage is full, files can not be updated or synced anymore!" : "พื้นที่จัดเก็บข้อมูลของคุณเต็มแล้ว ไม่สามารถอัปเดตหรือประสานข้อมูลได้อีก!",
    ...
    "Unlock failed with status {status}" : "ปลดล็อคล้มเหลวรหัสสถานะคือ {status}",
    "Locks" : "ล็อค",
    "Resource is not locked" : "ข้อมูลไม่ได้ถูกล็อค",
    "Path" : "เส้นทาง",
    "_%n byte_::_%n bytes_" : ["%n ไบต์"],
    "Favorited" : "รายการโปรด",
    "Favorite" : "รายการโปรด",
    "Private link:  Only people who have access to the file/folder can use it. Use it as a permanent link for yourself or to point others to files within shares" : "ลิงก์ส่วนตัว: สร้างลิงก์ถาวรสำหรับคุณเองและยังสามารถแชร์ให้กับคนอื่นๆได้ด้วย",
    "Folder" : "สร้างโฟลเดอร์ใหม่",
    "New folder" : "โฟลเดอร์ใหม่",
    "{newname} already exists" : "{newname} ถูกใช้ไปแล้ว",
    "Upload" : "อัปโหลดไฟล์",
    "An error occurred while trying to update the tags" : "เกิดข้อผิดพลาดขณะที่พยายามจะอัปเดตแท็ก",
    ...
    "WebDAV" : "WebDAV",
    "Use this address to <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">access your Files via WebDAV</a>" : "<a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">เข้าถึงไฟล์ของคุณผ่าน WebDAV</a>",
    ...
    "The files you are trying to upload exceed the maximum size for file uploads on this server." : "ไฟล์ที่คุณพยายามอัปโหลดมีขนาดเกินกว่าขนาดสูงสุดที่กำหนดไว้ให้อัปโหลดได้สำหรับเซิร์ฟเวอร์นี้",
