OC.L10N.register(
    ...
    "Close" : "关闭",
    "Favorites" : "收藏",
    "Upload timeout for file \"{file}\"" : "上传文件 {file} 超时",
    "Unknown error \"{error}\" uploading file \"{file}\"" : "上传文件 {file} 时发生未知错误：{error}",
    ...
    "The file \"{fileName}\" is locked and can not be renamed." : "文件“{fileName}”已被锁定，无法重命名。",
    ...
    "The file \"{fileName}\" is locked and cannot be deleted." : "文件“{fileName}”已被锁定，无法删除。",
    ...
    "_including %n hidden_::_including %n hidden_" : ["包含 %n 隐藏项"],
    ...
    "File name cannot contain \"/\"." : "文件名不得包含“/”。",
    "\"{name}\" has a forbidden file type/extension." : "\"{name}\" 的文件类型/扩展名被禁止。",
