OC.L10N.register(
    ...
    "Socket" : "התקן קלט פלט",
    "Clamav Socket" : "מחבר Clamav",
    "Host" : "מארח",
    "Hostname or IP address of Antivirus Host" : "שם מארח או כתובת IP של שרת האנטי וירוס",
    "Port" : "פורט",
    "Port number of Antivirus Host, 1-65535" : "מספר יציאת מחשב (port) של שרת האנטי וירוס, 1-65535",
    "Path to clamscan" : "נתיב אל clamscan",
    "Path to clamscan executable" : "נתיב לקובץ ההפעלה של clamscan",
    "Extra command line options (comma-separated)" : "אפשרויות שורת פקודה נוספות (מופרד באמצעות פסיקים)",
    "Stream Length" : "אורך הזרם",
    "ClamAV StreamMaxLength value in bytes" : "ערך ClamAV StreamMaxLength בבייטים",
    "bytes" : "בייטים",
    "File size limit, -1 means no limit" : "הגבלת גודל קובץ, -1 מסמל ללא הגבלה",
    "File size limit in bytes, -1 means no limit" : "הגבלת גודל קובץ בבייטים, -1 מסמל ללא הגבלה",
    "When infected files were found during a background scan" : "כאשר מתגלים קבצים נגועים בזמן סריקת רקע",
    "Only log" : "רק לוג",
