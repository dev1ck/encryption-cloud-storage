OC.L10N.register(
    ...
    "Saving..." : "저장 중...",
    "Test scan was unsuccessful. Please recheck antivirus settings." : "테스트 검사가 실패했습니다. 안티바이러스 설정을 다시 확인하십시오.",
    ...
    "Host" : "호스트",
    "Hostname or IP address of Antivirus Host" : "안티바이러스 호스트의 이름이나 IP 주소",
    "Port" : "포트",
    "Port number of Antivirus Host, 1-65535" : "안티바이러스 호스트의 포트 번호, 1-65535",
    "Path to clamscan" : "clamscan 경로",
    "Path to clamscan executable" : "clamscan 실행 파일 경로",
    "Extra command line options (comma-separated)" : "추가 명령행 옵션(쉼표로 구분)",
    "Stream Length" : "스트림 길이",
    "ClamAV StreamMaxLength value in bytes" : "바이트 단위 ClamAV StreamMaxLength 값",
    "bytes" : "바이트",
    "File size limit, -1 means no limit" : "파일 크기 제한, -1은 제한 없음",
    "File size limit in bytes, -1 means no limit" : "바이트 단위 파일 크기 제한, -1은 무제한",
    "When infected files were found during a background scan" : "백그라운드 검사에서 감염된 파일을 발견했을 때 행동",
    "Only log" : "기록만",
    "Delete file" : "파일 삭제",
    "Save" : "저장",
    "Advanced" : "고급",
