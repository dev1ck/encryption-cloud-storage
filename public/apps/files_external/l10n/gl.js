OC.L10N.register(
    ...
    "An error occured while adding the external storage, please check the logs or contact the administrator" : "Produciuse un erro ao engadir o almacenamento externo. Comprobe os rexistros ou póñase en contacto co administrador",
    "External storage has been added successfully" : "O almacenamento externo engadiuse correctamente",
    "An error occured while adding the external storage please check the logs" : "Produciuse un erro ao engadir o almacenamento externo. Comprobe os rexistros",
    "Saved" : "Gardado",
