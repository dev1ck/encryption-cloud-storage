OC.L10N.register(
    ...
    "Unknown auth backend \"{b}\"" : "מנגנון האימות „{b}” אינו ידוע",
    ...
    "An error occured while adding the external storage, please check the logs or contact the administrator" : "אירעה שגיאה בהוספת האחסון החיצוני, נא לעיין ביומנים או ליצור קשר עם הנהלת המערכת.",
    "External storage has been added successfully" : "אחסון חיצוני נוסף בהצלחה",
    "An error occured while adding the external storage please check the logs" : "אירעה שגיאה בהוספת האחסון החיצוני, נא לעיין ביומנים",
    "Saved" : "נשמר",
    "Disabling external storage will unmount all storages for all users, are you sure ?" : "השבתת אחסון חיצוני תסיר את כל האחסונים של כל המשתמשים, להמשיך?",
    "Disable external storage" : "השבתת אחסון חיצוני",
    "No URL provided by backend " : "לא סופק נתיב אינטרנט על ידי המנגנון",
    "Error getting OAuth2 URL for " : "שגיאה בקבלת נתיב אינטרנט OAuth2 עבור ",
    "Empty response from the server" : "תגובה ריקה מהשרת",
    "Couldn't access. Please logout and login to activate this mount point" : "לא ניתן לגשת. יש לצאת ולהיכנס כדי להפעיל את נקודת העיגון הזו",
    ...
    "SMB Personal (unique file IDs)" : "SMB אישי (מזהי קבצים יחודיים)",
    "Share" : "שיתוף",
    "Domain" : "שם תחום",
    "SMB Collaborative (shared file IDs)" : "שיתופי פעולה SMB (מזהי קבצים יחודיים)",
    "Service Account" : "חשבון שירות",
    "Service Account Password" : "סיסמת חשבון שירות",
    ...
    "You can add external storages in the storage settings" : "ניתן להוסיף זכרונות חיצוניים בהגדרות הזכרון",
    "Name" : "שם",
    ...
    "External Storage" : "אחסון חיצוני",
    "Enable external storage" : "הפעלת אחסון חיצוני",
    "External storage has been disabled by the administrator" : "אחסון חיצוני הופעל על ידי המנהל",
