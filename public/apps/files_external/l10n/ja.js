OC.L10N.register(
    ...
    "Saved" : "保存されました",
    "Disabling external storage will unmount all storages for all users, are you sure ?" : "外部ストレージを無効化すると、すべてのユーザーに影響を与えます。続行しますか？",
    "Disable external storage" : "外部ストレージを無効化",
    "Error getting OAuth2 URL for " : "次のOAuth2 URL 取得エラー ",
    "Empty response from the server" : "サーバーから空の応答がありました",
    "Couldn't access. Please logout and login to activate this mount point" : "アクセスできません｡このマウントポイントを有効にするには、一度ログアウトしてからログインしてください。",
    "Couldn't get the information from the ownCloud server: {code} {type}" : "ownCloudサーバーから情報を取得できません: {code} {type}",
    "Couldn't get the list of external mount points: {type}" : "外部マウントポイントのリストを取得できません: {type}",
    "There was an error with message: " : "メッセージ付きのエラーが発生しました：",
    "External mount error" : "外部マウントエラー",
    "Couldn't get the list of Windows network drive mount points: empty response from the server" : "Windowsネットワークドライブのマウントポイントリストを取得できません:サーバーから空の応答がありました",
    ...
    "You can add external storages in the storage settings" : "ストレージ設定で外部ストレージを設定することができます。",
    "Name" : "名前",
    "Storage type" : "ストレージ種別",
    "Scope" : "スコープ",
    "Enable encryption" : "暗号化を有効に",
    "Set read-only" : "読み取り専用にする",
    ...
    "External Storage" : "外部ストレージ",
    "Enable external storage" : "外部ストレージを有効化",
    "External storage has been disabled by the administrator" : "外部ストレージが管理者によって無効化されました",
    "Folder name" : "フォルダー名",
    "Authentication" : "認証",
    "Configuration" : "設定",
    "Available for" : "利用可能",
