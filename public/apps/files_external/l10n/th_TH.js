OC.L10N.register(
    ...
    "Google Drive App Configuration" : "ตั้งค่าแอปฯ Google Drive",
    ...
    "Please provide a valid app key and secret." : "โปรดระบุคีย์และรหัสลับของแอปฯ ให้ถูกต้อง",
    ...
    "An error occured while adding the external storage, please check the logs or contact the administrator" : "เกิดข้อผิดพลาดขณะเพิ่มที่เก็บข้อมูลภายนอกโปรดตรวจสอบ Log หรือติดต่อผู้ดูแลระบบ",
    "External storage has been added successfully" : "เพิ่มที่เก็บข้อมูลภายนอกเรียบร้อยแล้ว",
    "An error occured while adding the external storage please check the logs" : "เกิดข้อผิดพลาดขณะเพิ่มที่เก็บข้อมูลภายนอกโปรดตรวจสอบ Log",
    "Saved" : "บันทึกแล้ว",
    ...
    "Disable external storage" : "ปิดการใช้งานพื้นที่จัดเก็บข้อมูลภายนอก",
    "No URL provided by backend " : "ไม่มี URL ที่มาจากแบ็กเอนด์",
    "Error getting OAuth2 URL for " : "เกิดข้อผิดพลาดในการรับ URL OAuth2 สำหรับ",
    ...
    "Please enter the credentials for the {mount} mount" : "กรุณากรอกหนังสือรับรองสำหรับ {mount} ",
    "Username" : "ชื่อผู้ใช้งาน",
    "Password" : "รหัสผ่าน",
    "Credentials saved" : "หนังสือรับรองได้ถูกบันทึก",
    "Credentials saving failed" : "บันทึกหนังสือรับรองล้มเหลว",
    "Credentials required" : "จำเป็นต้องระบบหนังสือรับรอง",
    "Save" : "บันทึก",
    ...
    "SMB Personal (unique file IDs)" : "SMB Personal (ID ของไฟล์เฉพาะ)",
    "Share" : "แชร์",
    "Domain" : "โดเมน",
    "SMB Collaborative (shared file IDs)" : "SMB Collaborative (ID ของไฟล์แชร์)",
    "Service Account" : "บัญชีบริการ",
    "Service Account Password" : "รหัสผ่านของบัญชีบริการ",
    "SMB / CIFS using OC login" : "SMB/CIFS กำลังใช้ OC เข้าสู่ระบบ",
    "Username as share" : "ชื่อผู้ใช้ที่แชร์",
    "<b>Note:</b> " : "<b>หมายเหตุ:</b>",
    "<b>Note:</b> The cURL support in PHP is not enabled or installed. Mounting of %s is not possible. Please ask your system administrator to install it." : "<b>หมายเหตุ:</b> ยังไม่ได้ติดตั้ง PHP (cURL) จึงทำให้ไม่สามารถเรียกใช้งาน %s กรุณาติดต่อผู้ดูแลระบบของคุณ",
    "<b>Note:</b> \"%s\" is not installed. Mounting of %s is not possible. Please ask your system administrator to install it." : "<b>หมายเหตุ:</b> ยังไม่ได้ติดตั้ง %s มันเป็นเป็นไม่ได้ที่จะเรียกใช้งาน Protocol %s กรุณาติดต่อผู้ดูแลระบบของคุณ",
    "No external storage configured" : "ไม่มีการใช้งานการจัดเก็บข้อมูลภายนอก",
    "You can add external storages in the storage settings" : "คุณสามารถเพิ่มการจัดเก็บข้อมูลภายนอกในการตั้งค่าพื้นที่เก็บข้อมูลได้",
    "Name" : "ชื่อ",
    ...
    "External Storage" : "พื้นทีจัดเก็บข้อมูลภายนอก",
    "Enable external storage" : "เปิดการใช้งานพื้นที่จัดเก็บข้อมูลภายนอก",
    "External storage has been disabled by the administrator" : "ผู้ดูแลระบบได้ปิดการใช้งานการจัดเก็บข้อมูลภายนอก",
    ...
    "Allow sharing on user-mounted external storages" : "อนุญาตให้แชร์การจัดเก็บข้อมูลภายนอกของผู้ใช้"
},
"nplurals=1; plural=0;");
