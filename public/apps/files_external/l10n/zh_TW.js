OC.L10N.register(
    ...
    "Admin defined" : "管理員定義",
    "An error occured while adding the external storage, please check the logs or contact the administrator" : "加入外部儲存時發生錯誤，請檢查伺服器紀錄或連繫管理員。",
    "External storage has been added successfully" : "已成功添加外部儲存。",
    "An error occured while adding the external storage please check the logs" : "添加外部儲存時發生錯誤，請檢查伺服器紀錄。",
    "Saved" : "已儲存",
