OC.L10N.register(
    ...
    "Click to select files or use drag & drop to upload" : "Кликнете, за да изберете файлове или използвайте „drag & drop“ за качване",
    ...
    "An error occurred while updating share state: {message}" : "Възникна грешка при актуализиране на състоянието на споделянето: {message}",
    "Accept Share" : "Приемете споделянето",
    "Decline Share" : "Отклонете споделянето",
    ...
    "You unshared %1$s shared by %2$s from self" : "Вие не споделяте %1$s споделеният %2$s със себе си",
    ...
    "Unshared %1$s from self" : "Вие не споделяте %1$s със себе си",
    ...
    "Couldn't send mail to following recipient(s): %s " : "Не можа да се изпрати поща до следният получател(и): %s",
    ...
    "Could not update share" : "Не можа да се актуализира споделянето",
    ...
    "Exclude groups from receiving shares" : "Изключени групи от получаване на споделяния",
