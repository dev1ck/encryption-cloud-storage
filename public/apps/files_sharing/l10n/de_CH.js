OC.L10N.register(
    ...
    "\"%1$s\" invited you to view \"%3$s\"" : "\"%1$s\" hat dich eingeladen \"%3$s\" anzusehen",
    "Accept" : "Akzeptieren",
    "Decline" : "Abgelehnt",
    "Automatically accept new incoming local user shares" : "Neue lokale Benutzerfreigaben automatisch akzeptieren",
    "Allow finding you via autocomplete in share dialog. If this is disabled the full username needs to be entered." : "Ermögliche die Suche nach dir über die Autovervollständigung im Freigabedialog. Wenn dies deaktiviert ist, muss der vollständige Benutzername eingegeben werden.",
