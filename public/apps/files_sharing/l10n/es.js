OC.L10N.register(
    ...
    "Anonymous upload" : "Subida anónima",
    "Click to select files or use drag & drop to upload" : "Click Para seleccionar archivos o use arrastrar y soltar para subir",
    ...
    "Could not update share" : "No se pudo actualizar la compartición",
    ...
    "Only recipient can change accepted state" : "Solo el receptor puede cambiar el cambio de estado.",
    ...
    "Allow finding you via autocomplete in share dialog. If this is disabled the full username needs to be entered." : "Permite que lo encuentren a través del completado automático en un diálogo de compartición. Si esta opción está deshabilitada es necesario introducir el nombre de usuario completo.",
