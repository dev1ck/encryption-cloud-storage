OC.L10N.register(
    ...
    "Not allowed to create a federated share with the same user server" : "ไม่อนุญาตให้สร้างแชร์สหพันธ์กับเซิร์ฟเวอร์ที่มีผู้ใช้เดียวกัน",
    ...
    "Files and folders you share by link will show up here" : "ไฟล์และโฟลเดอร์ที่คุณแชร์โดยลิงก์จะปรากฏขึ้นที่นี่",
    ...
    "You can upload into this folder" : "คุณสามารถอัปโหลดลงในโฟลเดอร์นี้",
    ...
    "%2$s shared %1$s via link" : "%2$s ได้แชร์ %1$s ผ่านลิงก์",
    "You shared %1$s via link" : "คุณแชร์ %1$s ผ่านลิงก์",
    "You removed the public link for %1$s" : "คุณได้ลบลิงก์สาธารณะสำหรับ %1$s",
    "%2$s removed the public link for %1$s" : "%2$s ได้ลบลิงก์สาธารณะสำหรับ %1$s",
    "Your public link for %1$s expired" : "ลิงก์สาธารณะของคุณสำหรับ %1$s หมดอายุ",
    "The public link of %2$s for %1$s expired" : "ลิงก์สาธารณะของ  %2$s สำหรับ %1$s หมดอายุ",
    "%2$s shared %1$s with you" : "%2$s ถูกแชร์ %1$s กับคุณ",
    "%2$s removed the share for %1$s" : "%2$s ได้ลบแชร์สำหรับ %1$s",
    "Downloaded via public link" : "ดาวน์โหลดผ่านลิงก์สาธารณะ",
    ...
    "Shared via link by %2$s" : "แชร์ผ่านลิงก์โดย %2$s",
    "Shared via public link" : "แชร์ผ่านลิงก์สาธารณะ",
    "Removed public link" : "ลิงก์สาธารณะถูกลบแล้ว",
    "%2$s removed public link" : "%2$s ได้ลบลิงก์สาธารณะแล้ว",
    "Public link expired" : "ลิงก์สาธารณะหมดอายุแล้ว",
    "Public link of %2$s expired" : "ลิงก์สาธารณะของ %2$s หมดอายุแล้ว",
    "Shared by %2$s" : "แชร์โดย %2$s",
    "Shares" : "แชร์",
    "File sharing" : "กำลังแชร์ไฟล์",
    "Public link" : "ลิงก์สาธารณะ",
    "Couldn't send mail to following recipient(s): %s " : "ไม่สามารถส่งอีเมลไปยังผู้รับต่อไปนี้: %s",
    "Share API is disabled" : "แชร์ API ถูกปิดใช้งาน",
    "Wrong share ID, share doesn't exist" : "แชร์ไอดีผิด หรือ ไม่มีแชร์นั้นอยู่",
    "Share points to a node not available" : "ไม่สามารถแชร์คะแนนไปยังโหนด",
    ...
    "Public upload disabled by the administrator" : "อัปโหลดสาธารณะถูกปิดใช้งานโดยผู้ดูแลระบบ",
    "Public upload is only possible for publicly shared folders" : "อัปโหลดสาธารณะจะทำได้เฉพาะโฟลเดอร์ที่แชร์กับสาธารณะ",
    ...
    "shareWith parameter must be a string" : "แชร์พารามิเตอร์จะต้องเป็นสตริง",
    "Unknown share type" : "ไม่รู้จักประเภทของแชร์",
    "Could not lock path" : "ไม่สามารถล็อคเส้นทาง",
    "Not a directory" : "ไม่ได้เป็นไดเรกทอรี",
    "Could not update share" : "ไม่สามารถอัปเดตการแชร์",
    "Can't change permissions for public share links" : "ไม่สามารถเปลี่ยนสิทธิ์สำหรับลิงก์แชร์สาธารณะ",
    "Only recipient can change accepted state" : "เฉพาะผู้รับเท่านั้นที่สามารถเปลี่ยนสถานะที่ยอมรับได้",
    ...
    "Allow finding you via autocomplete in share dialog. If this is disabled the full username needs to be entered." : "อนุญาตให้ค้นหาคุณผ่านกล่องข้อความอัตโนมัติ (จำเป็นต้องป้อนชื่อ-นามสกุลของผู้ใช้หากฟังก์ชันนี้ถูกปิดใช้งาน)",
    ...
    "Sorry, this link doesn’t seem to work anymore." : "ขออภัยลิงก์นี้ดูเหมือนจะไม่ทำงานอีกต่อไป",
    "Reasons might be:" : "เหตุผลอาจจะ:",
    "the item was removed" : "รายการที่ถูกลบออก",
    "the link expired" : "ลิงก์หมดอายุ",
    "sharing is disabled" : "การแชร์ถูกปิดใช้งาน",
    "For more info, please ask the person who sent this link." : "สำหรับข้อมูลเพิ่มเติมกรุณาสอบถามผู้ที่ส่งลิงก์นี้",
