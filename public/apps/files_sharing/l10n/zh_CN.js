OC.L10N.register(
    ...
    "The group is blacklisted for sharing" : "组被禁止使用分享",
    ...
    "Only recipient can change accepted state" : "只有收到分享一方才能改变接受的状态",
    ...
    "Group Sharing Blacklist" : "禁止分享的组的列表",
    "Exclude groups from receiving shares" : "禁止组接受分享",
    "These groups will not be available to share with. Members of the group are not restricted in initiating shares and can receive shares with other groups they are a member of as usual." : "不能分享给这些组。组的成员没有被限制发起分享，也可以通过作为其它组的成员接受分享。"
},
"nplurals=1; plural=0;");
