OC.L10N.register(
    ...
    "Redirect URI must not be empty" : "La URI de redirección no puede estar vacía",
    "Redirect URI must be a valid URL" : "La URI de redirección debe ser una URL válida",
    "Name %s already exists" : "El nombre %s ya existe",
    "Client id must be a number" : "El ID de cliente debe ser un número",
    ...
    "Authorize" : "Autorizar",
    "Switch users to continue" : "Cambiar de usuario para continuar",
    "OAuth 2.0" : "OAuth 2.0",
    ...
    "You are logged in as %s but the application requested access for user %s." : "Se ha logado como %s pero la aplicación pide acceso del usuario %s."
},
