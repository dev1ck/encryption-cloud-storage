OC.L10N.register(
    ...
    "%1$s assigned system tag %3$s to %2$s" : "%1$s сложи системен етикет %3$s на %2$s",
    "You unassigned system tag %3$s from %2$s" : "Премахнахте системен етикет %3$s от %2$s",
    "%1$s unassigned system tag %3$s from %2$s" : "%1$s премахна системен етикет %3$s от %2$s",
