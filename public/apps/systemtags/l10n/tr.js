OC.L10N.register(
    ...
    "You assigned system tag %3$s to %2$s" : "%3$s sistem etiketini %2$s olarak atadınız",
    "%1$s assigned system tag %3$s to %2$s" : "%1$s, %3$s sistem etiketini %2$s etiketine atadı",
    "You unassigned system tag %3$s from %2$s" : "%3$s sistem etiketini %2$s üzerinden kaldırdınız",
