OC.L10N.register(
    ...
    "Recipients can view, download, edit, delete and upload contents." : "Příjemce může zobrazit, stáhnout, upravovat, mazat a nahrávat obsah.",
    "Upload only" : "Jen k nahrání",
    "Receive files from multiple recipients without revealing the contents of the folder." : "Přijmout soubory od několika příjemců, kteří neuvidí obsah složky.",
    ...
    "Upgrade to ownCloud Enterprise" : "Upgradujte na ownCloud Enterprise",
    "Remaining time: {rtime}" : "Zbývající čas: {rtime}",
    "Get your demo key" : "Získejte vlastní demo klíč",
    "Enter license key" : "Vložte licenční klíč",
    "Set new key" : "Nastavit nový klíč",
    ...
    "Error adding {addItem}: {addItem} already exists" : "Chyba přidání {addItem}: {addItem} již existuje",
    "No" : "Ne",
    "Yes" : "Ano",
    "Choose" : "Vybrat",
    ...
    "An error occurred while sending email" : "Nastala chyba při odesílání emailu",
    ...
    "Email notification was sent!" : "Emailové upozornění odesláno!",
    "Email notification not sent" : "Emailové upozornění neodesláno",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Více informací naleznete v <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">serverovém logu</a>.",
    ...
    "You took too long to log in, please try again now" : "Přihlášení Vám trvalo příliš dlouho, prosím, zkuste to nyní znovu",
    ...
    "Personal note from the sender: <br> %s." : "Osobní poznámka odesílatele: <br> %s.",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Kontaktujte prosím svého správce. Pokud spravujete tuto instalaci, nastavte \"trusted_domains\" v souboru config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Ukázková konfigurace je v souboru config/config.sample.php nebo v <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">dokumentaci</a>.",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "Vypadá to, že vaše instance má velké množství souborů a/nebo uživatelů. K poklidné aktualizaci použijte prosím příkazovou řádku (occ upgrade).",
    "Automatic updating is disabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Automatická aktualizace je zakázána v config.php. K aktualizaci použijte prosím příkazovou řádku (occ upgrade).",
