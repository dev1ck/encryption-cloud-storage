OC.L10N.register(
    ...
    "Could not reset password because the token expired" : "Das Passwort konnte nicht zurückgesetzt werden, da der Token abgelaufen ist",
    "Could not reset password because the token does not match" : "Das Passwort konnte aufgrund eines nicht übereinstimmenden Tokens nicht zurückgesetzt werden",
    ...
    "Checking whether the database schema can be updated (this can take a long time depending on the database size)" : "Prüfen, ob das Datenbankschema aktualisiert werden kann (dies kann je nach Datenbankgrösse sehr lange dauern)",
    ...
    "Checking whether the database schema for %s can be updated (this can take a long time depending on the database size)" : "Prüfen, ob das Datenbankschema für %s aktualisiert werden kann (dies kann je nach Datenbankgrösse sehr lange dauern)",
    ...
    "Nov." : "Nov.",
    "Dec." : "Dez.",
    "<a href=\"{docUrl}\">There were problems with the code integrity check. More information…</a>" : "<a href=\"{docUrl}\">Es gab Probleme mit der Code - Integritätsprüfung. Mehr Informationen…</a>",
    ...
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "Du hast eine oder mehrere ownCloud Enterprise-Anwendungen aktiviert, aber die Installation verfügt über keine gültige Lizenz.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Eine Demo von 24 Stunden ist gerade gestartet damit Du sofort loslegen kannst. Nach Ablauf dieser Frist werden alle Enterprise-Anwendungen deaktiviert, es sei denn, Du gibst einen gültigen Lizenzschlüssel an.",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Um ownCloud Enterprise auszuprobieren, starte einfach eine 30-Tage-Demo und gib den unten angegebenen Lizenzschlüssel ein.",
    "Upgrade to ownCloud Enterprise" : "Upgrade auf ownCloud Enterprise",
    "Remaining time: {rtime}" : "Verbleibende Zeit: {rtime}",
    "Get your demo key" : "Demo-Lizenzschlüssel anfordern",
    "Enter license key" : "Lizenzschlüssel eintragen",
    "Set new key" : "Neuen Lizenzschlüssel eintragen",
    ...
    "I know what I'm doing" : "Ich weiss, was ich mache",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Sie befinden sich im DEBUG Modus. Dies kann zu unerwarteten Effekten führen. Bitte entfernen Sie das \"debug\" Flag aus der \"config.php\".",
    ...
    "Choose an expiration date" : "Wähle ein Ablaufdatum",
    ...
    "Filename" : "Dateiname",
    "Password" : "Passwort",
    "Can not remove required password" : "Das Passwort kann nicht entfernt werden",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Bitte mindestens {chars} Zeichen eingeben für Vorschläge","Bitte mindestens {chars} Zeichen eingeben für Vorschläge"],
    ...
    "Sharing is not allowed" : "Teilen nicht erlaubt",
    ...
    "Unknown Share" : "Unbekannte Freigabe",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Weitere Details können im <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">Serverprotokoll</a> gefunden werden.",
    ...
    "This application requires JavaScript for correct operation. Please {linkstart}enable JavaScript{linkend} and reload the page." : "Diese Anwendung benötigt zum ordnungsgemässen Betrieb JavaScript. Bitte {linkstart}aktiviere JavaScript{linkend} und lade die Seite neu.",
    "Menu" : "Menü",
    "Log out" : "Abmelden",
    "Search" : "Suche",
    ...
    "You took too long to log in, please try again now" : "Du hast zu lange zum Einloggen gebraucht, bitte versuche es erneut",
    ...
    "Personal note from the sender: <br> %s." : "Persönliche Notiz vom Absender: <br>%s.",
    ...
    "Enhanced security has been enabled for your account. Please authenticate using a second factor." : "Die erweiterte Sicherheit wurde für dein Konto aktiviert. Bitte authentisiere dich mit einem zweiten Faktor. ",
    ...
    "To avoid timeouts with larger installations, you can instead run the following command from your installation directory:" : "Zur Vermeidung von Zeitüberschreitungen bei grösseren Installationen kannst Du stattdessen den folgenden Befehl in Deinem Installationsverzeichnis ausführen:",
    ...
    "For help, see the  <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Für weitere Hilfe bitte in die <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">Dokumentation</a> schauen.",
