OC.L10N.register(
    ...
    "No valid crop data provided" : "Keine gültigen Zuschnittsdaten zur Verfügung gestellt",
    ...
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "Sie haben eine oder mehrere ownCloud Enterprise-Apps aktiviert, aber Ihre Installation verfügt über noch keinen gültigen Lizenzschlüssel.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Eine Demo von 24 Stunden ist gerade gestartet, damit Sie sofort loslegen können. Nach Ablauf dieser Frist werden alle Enterprise-Anwendungen deaktiviert, es sei denn, Sie geben einen gültigen Lizenzschlüssel an.",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Um ownCloud Enterprise auszuprobieren, starten Sie eine 30-tägige Demo und geben Sie den dort angegebenen Lizenzschlüssel unten ein.",
    "Upgrade to ownCloud Enterprise" : "Upgrade auf ownCloud Enterprise",
    "Remaining time: {rtime}" : "Verbleibende Zeit: {rtime}",
    "Get your demo key" : "Demo-Lizenzschlüssel erhalten",
    "Enter license key" : "Lizenzschlüssel eingeben:",
    "Set new key" : "Neuen Lizenzschlüssel eingeben:",
    ...
    "Error adding {addItem}: {addItem} already exists" : "Fehler beim hinzufügen von {addItem}: {addItem} existiert bereits",
    "No" : "Nein",
    "Yes" : "Ja",
    "Choose" : "Auswählen",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "ownCloud wird im DEBUG Modus ausgeführt. Dies kann zu unerwünschten Seiteneffekten führen. Bitte entfernen Sie das \"debug\" flag in der \"config.php\".",
    ...
    "Please contact the server administrator if this error reappears multiple times and include the technical details below in your report." : "Bitte wenden Sie sich an den Serveradministrator, wenn dieser Fehler mehrfach auftritt und geben Sie bitte die, unten stehenden, technischen Details in Ihrem Bericht mit an.",
    ...
    "You took too long to log in, please try again now" : "Sie haben zu lange zum Einloggen gebraucht, bitte versuchen Sie es erneut",
    "Wrong password. Reset it?" : "Falsches Passwort. Soll es zurückgesetzt werden?",
    "Wrong password." : "Falsches Passwort.",
    "You are trying to access a private link. Please log in first." : "Sie versuchen auf einen privaten Link zuzugreifen. Bitte erst anmelden.",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Bitte kontaktieren Sie Ihren Administrator. Wenn Sie Administrator dieser Instanz sind, konfigurieren Sie bitte die „trusted_domains“-Einstellung in config/config.php.",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "Es scheint, dass Ihre Instanz viele Dateien und / oder Benutzer verwaltet. Um einen reibungslosen Upgradeprozess sicherzustellen, bitte den Kommandozeilenupdater (occ upgrade) verwenden.",
