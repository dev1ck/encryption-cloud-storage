OC.L10N.register(
    ...
    "Could not reset password because the token expired" : "Could not reset password because the token expired",
    "Could not reset password because the token does not match" : "Could not reset password because the token does not match",
    ...
    "Download / View / Edit" : "Download / View / Edit",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\".",
    ...
    "There are currently no link shares, you can create one" : "There are currently no link shares, you can create one",
    "Anyone with the link has access to the file/folder" : "Anyone with the link has access to the file/folder",
    "Copied!" : "Copied!",
    ...
    "Filename" : "Filename",
    "Password" : "Password",
    "Can not remove required password" : "Can not remove required password",
    "Edit link share: {name}" : "Edit link share: {name}",
    "Create link share: {name}" : "Create link share: {name}",
    "Share" : "Share",
    "Save" : "Save",
    ...
    "Email notification not sent" : "Email notification not sent",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Please enter at least {chars} character for suggestions","Please enter at least {chars} characters for suggestions"],
    ...
    "Sharing is not allowed" : "Sharing is not allowed",
    ...
    "Personal note from the sender: \n %s." : "Personal note from the sender: \n %s.",
    "Cheers!" : "Cheers!",
    ...
    "Please contact the server administrator if this error reappears multiple times and include the technical details below in your report." : "Please contact the server administrator if this error reappears multiple times and include the technical details below in your report.",
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>.",
    ...
    "You are trying to access a private link. Please log in first." : "You are trying to access a private link. Please log in first.",
    ...
    "Personal note from the sender: <br> %s." : "Personal note from the sender: <br> %s.",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade).",
    "Automatic updating is disabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "Automatic updating is disabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade).",
