OC.L10N.register(
    ...
    "Checked database schema update" : "Actualización del esquema de base de datos chequeado",
    "Sunday" : "Domingo",
    "Monday" : "Lunes",
    "Tuesday" : "Martes",
    "Wednesday" : "Miércoles",
    ...
    "Password can not be changed. Please contact your administrator." : "La contraseña no puede ser cambiada. Por favor contacte al administrador.",
    "No" : "No",
    "Yes" : "Sí",
    "Choose" : "Elegir",
    ...
    "The public link will expire no later than {days} days after it is created" : "El enlace público expirará no antes de {days} días después de su creación",
    ...
    "Anyone with the link has access to the file/folder" : "Cualquiera que tenga acceso al enlace del archivo/carpeta",
    ...
    "Hey there,<br><br>just letting you know that %s shared <strong>%s</strong> with you.<br><a href=\"%s\">View it!</a><br><br>" : "¡Hola!<br><br> Sólo te quería informar que %s acaba de compartir <strong>%s</strong> con vos.<br><a href=\"%s\">Verlo!</a><br><br>",
