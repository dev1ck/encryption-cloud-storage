OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Impossible de réinitialiser le mot de passe car le jeton est non valable",
    "Could not reset password because the token expired" : "Impossible de réinitialiser le mot de passe car le jeton a expiré.",
    "Could not reset password because the token does not match" : "Impossible de réinitialiser le mot de passe car le jeton ne correspond pas.",
    ...
    "Recipients can view, download and upload contents." : "Les bénéficiaires peuvent voir, télécharger, modifier et téléverser le contenu.",
    "Download / View / Edit" : "Télécharger / Voir / Modifier",
    ...
    "Upload only" : "Téléverser seulement",
    "Receive files from multiple recipients without revealing the contents of the folder." : "Recevoir des fichiers de plusieurs bénéficiaires sans révéler le contenu du dossier.",
    ...
    "Get your demo key" : "Obtenez votre clé de démonstration",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Vous êtes en mode DÉBOGAGE , cela peut causer des effets non voulus, Veuillez supprimer le drapeau \"debug\" du fichier \"config.php\".",
    ...
    "There are currently no link shares, you can create one" : "Il n'y a pour le moment aucun lien de partage. Vous pouvez en créer un",
    "Anyone with the link has access to the file/folder" : "Quiconque dispose du lien a accès aux fichiers/dossiers",
    "Copied!" : "Copié !",
    ...
    "Can not remove required password" : "Impossible de supprimer le mot de passe obligatoire",
    "Edit link share: {name}" : "Editer le lien de partage : {name}",
    "Create link share: {name}" : "Créer le lien de partage : {name}",
    "Share" : "Partager",
    "Save" : "Enregistrer",
    "Remove password" : "Effacer le mot de passe",
    ...
    "An error occurred while sending email" : "Une erreur s'est produite lors de l'envoi d'un e-mail",
    ...
    "Email notification not sent" : "La notification via email n'a pas été envoyée",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Veuillez saisir au moins {chars} caractère pour les suggestions","Veuillez saisir au moins {chars} caractères pour les suggestions"],
    "An error occurred. Please try again" : "Une erreur est survenue. Merci de réessayer",
    "User" : "Utilisateur",
    "Group" : "Groupe",
    "Guest" : "Invité",
    "At {server}" : "Sur {server}",
    "Federated" : "Fédéré",
    "User and Groups" : "Utilisateurs et groupes",
    "Public Links" : "Liens publics",
    "Sharing is not allowed" : "Le partage n’est pas autorisé",
    ...
    "Unknown Share" : "Partage inconnue",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Plus de détails peuvent être trouvés dans le <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">log du serveur</a>.",
    ...
    "You took too long to log in, please try again now" : "Vous avez mis trop de temps à vous connecter, veuillez réessayer maintenant",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Veuillez contacter votre administrateur. Si vous êtes l'administrateur, configurez les \"trusted_domains\" dans config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Un exemple de configuration est fourni dans config/config.sample.php ou sur la <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>.",
