OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Non foi posíbel restabelecer o contrasinal, o testemuño non é correcto",
    "Could not reset password because the token expired" : "Non foi posíbel restabelecer o contrasinal, o testemuño está caducado",
    "Could not reset password because the token does not match" : "Non foi posíbel restabelecer o contrasinal, o testemuño non coincide",
    ...
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "Activou unha ou varias aplicacións ownCloud Empresarial mais a súa instalación aínda non ten unha licenza válida.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Comezou un período de graza de 24 horas para permitirlle poñerse en marcha de inmediato. Unha vez que remate o período de graza, todas as aplicacións Empresarial quedarán desactivadas a menos que proporcione unha clave de licenza válida.",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Para probar ownCloud Empresarial, só ten que iniciar unha demostración de 30 días e escriba a clave de licenza indicada a seguir.",
    "Upgrade to ownCloud Enterprise" : "Anovar a ownCloud Empresarial",
    "Remaining time: {rtime}" : "Tempo restante: {rtime}",
    "Get your demo key" : "Obter a súa clave de demostración",
    "Enter license key" : "Introducir a clave de licenza",
    "Set new key" : "Estabelecer unha nova clave",
    ...
    "Your files are encrypted. If you haven't enabled the recovery key, there will be no way to get your data back after your password is reset.<br />If you are not sure what to do, please contact your administrator before you continue. <br />Do you really want to continue?" : "Os seus ficheiros están cifrados. Se non activou a clave de recuperación, non haberá maneira de recuperar os datos após o restabelecemento do contrasinal. <br />Se non está seguro de que facer, póñase en contacto co administrador antes de continuar. <br /> Confirma que quere continuar?",
    ...
    "An error occurred while sending email" : "Produciuse un erro ao enviar correo-e",
    ...
    "You took too long to log in, please try again now" : "Leva demasiado tempo para acceder, ténteo de novo agora",
