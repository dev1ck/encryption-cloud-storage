OC.L10N.register(
    ...
    "Could not reset password because the token expired" : "Gat ekki endurstillt lykilorðið vegna þess að teiknið er útrunnið",
    "Could not reset password because the token does not match" : "Gat ekki endurstillt lykilorðið vegna þess að teiknið samsvarar ekki",
    ...
    "Recipients can view, download and upload contents." : "Viðtakendur geta skoðað, sótt og sent inn efni.",
    "Download / View / Edit" : "Sækja / Skoða / Breyta",
    ...
    "Receive files from multiple recipients without revealing the contents of the folder." : "Fáðu skrár frá mörgum aðilum án þess að birta innihald möppunnar.",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Þú ert að keyra í DEBUG aflúsunarham, það getur valdið óvæntum aukaverkunum. Fjarlægðu \"debug\" flaggið úr \"config.php\".",
    ...
    "Email notification not sent" : "Tilkynning í tölvupósti ekki send",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">ownCloud community</a>." : "Uppfærslan tókst ekki. Sendu inn tilkynningu um vandamálið til <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">ownCloud samfélagsins</a>.",
    "The update was successful. There were warnings." : "Uppfærslan tókst. Það komu upp viðvaranir.",
    "The update was successful. Redirecting you to ownCloud now." : "Uppfærslan heppnaðist. Beini þér núna á ownCloud.",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Nánari upplýsingar er að finna í <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">atburðaskrá (annál) þjónsins</a>.",
    ...
    "Password changed successfully" : "Það tókst að breyta lykilorði",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Hafðu samband við kerfisstjóra. Ef þú ert stjórnandi á þessu tilviki, stilltu \"trusted_domains\" setninguna í config/config.php. ",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Dæmi um stillingar má sjá í config/config.sample.php. eða í <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">hjálparskjölunum</a>.",
