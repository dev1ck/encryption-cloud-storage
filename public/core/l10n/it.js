OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Reimpostazione della password fallita perchè il token non è valido",
    "Could not reset password because the token expired" : "Reimpostazione della password fallita perchè il token è scaduto",
    "Could not reset password because the token does not match" : "Reimpostazione della password fallita perchè il token non corrisponde",
    ...
    "Recipients can view, download and upload contents." : "I destinatari possono vedere,scaricare e inviare contenuti.",
    "Download / View / Edit" : "Scarica / Visiona / Modifica",
    ...
    "Error adding {addItem}: {addItem} already exists" : "Errore nell'aggiunta di {addItem}: {addItem} esiste già",
    "No" : "No",
    "Yes" : "Sì",
    "Choose" : "Scegli",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Stai utilizzando la modalità DEBUG, la quale potrebbe causare effetti indesiderati. Rimuovi il flag \"debug\" da \"config.php\".",
    ...
    "Expiration" : "Scadenza",
    "Choose an expiration date" : "Scegli una data di scadenza",
    ...
    "Social share" : "Condivisione sociale",
    "There are currently no link shares, you can create one" : "Al momento non ci sono collegamenti a condivisioni, puoi crearne uno",
    ...
    "Password" : "Password",
    "Can not remove required password" : "Impossibile rimuovere la password",
    "Edit link share: {name}" : "Modifica collegamento a condivisione: {name}",
    "Create link share: {name}" : "Creare collegamento a condivisione: {name}",
    "Share" : "Condividi",
    "Save" : "Salva",
    ...
    "Send copy to self" : "Invia una copia a me stesso",
    "Send link via email" : "Invia collegamento tramite email",
    "Add personal message" : "Aggiungi messaggio personale",
    "Sending" : "Invio in corso",
    "E-Mail sent" : "Email inviata",
    ...
    "Email notification was sent!" : "Notifica email inviata!",
    "Email notification not sent" : "Notifica email non inviata",
    ...
    "Sharing is not allowed" : "Condivisione non consentita",
    ...
    "Unknown Share" : "Condivisione sconosciuta",
    ...
    "Please contact the server administrator if this error reappears multiple times and include the technical details below in your report." : "Contatta l'amministratore del server se questo errore riappare più volte, includendo i dettagli tecnici sotto nella tua segnalazione.",
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Possono essere trovati altri dettagli nel <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">log del server</a>.",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Contatta il tuo amministratore di sistema. Se sei un amministratore di questa istanza, configura l'impostazione \"trusted_domains\" in config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Viene fornita una configurazione di esempio in config/config.sample.php o nella <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentazione</a>.",
    ...
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "Pare che la tua istanza stia gestendo molti file e/o utenti. Per assicurare un processo di aggiornamento senza intoppi, usa l'updater da riga di comando (occ upgrade).",
