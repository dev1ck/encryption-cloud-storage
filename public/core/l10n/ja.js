OC.L10N.register(
    ...
    "Download / View / Edit" : "ダウンロード/閲覧/編集",
    ...
    "Dismiss" : "閉じる",
    "seconds ago" : "数秒前",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "ownCloud Enterpriseの30日間のデモを試すには、提供されたパスキーを下に入力してください",
    "Upgrade to ownCloud Enterprise" : "ownCloud Enterpriseにアップグレード",
    "Remaining time: {rtime}" : "残り時間: {rtime}",
    "Get your demo key" : "デモキーを取得する",
    "Enter license key" : "ライセンスキーの入力",
    "Set new key" : "新しいキーの設定",
