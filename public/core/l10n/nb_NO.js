OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Klarte ikke å tilbakestille passordet fordi token er ugyldig.",
    "Could not reset password because the token expired" : "Klarte ikke å tilbakestille passordet fordi token er utløpt.",
    "Could not reset password because the token does not match" : "Klarte ikke å tilbakestille passordet fordi token ikke matcher.",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Du kjører i DEBUG-modus, dette kan forårsake uønskede bivirkninger. Vennligst fjern \"debug\" -flagget fra \"config.php\".",
    ...
    "Choose an expiration date" : "Velg en utløpsdato",
    ...
    "Social share" : "Deling på sosiale nettverk",
    "There are currently no link shares, you can create one" : "Det er for øyeblikket ingen lenke-delinger. Du kan opprette en",
    "Anyone with the link has access to the file/folder" : "Alle med linken har tilgang til filen/mappen",
    "Copied!" : "Kopiert!",
    "Not supported!" : "Ikke støttet!",
    "Press ⌘-C to copy." : "Trykk ⌘-C for å kopiere.",
    "Press Ctrl-C to copy." : "Trykk Ctrl-C for å kopiere.",
    "Choose a password" : "Velg passord",
    ...
    "Share to Twitter. Opens in a new window." : "Del på Twitter. Åpner et nytt vindu.",
    "Share to Facebook. Opens in a new window." : "Del på Facebook. Åpner et nytt vindu.",
    ...
    "Email notification was sent!" : "E-postvarsling ble sendt!",
    "Email notification not sent" : "E-postvarsling ikke sendt",
    ...
    "User" : "Bruker",
    "Group" : "Gruppe",
    "User and Groups" : "Bruker og grupper",
    "Public Links" : "Offentlige lenker",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Flere detaljer finner du i <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server loggen</a>.",
    ...
    "Please specify the port number along with the host name (e.g., localhost: 5432)." : "Vennligst spesifiser portnummer sammen med tjenernavn (feks. localhost:5432).",
    ...
    "You are trying to access a private link. Please log in first." : "Du prøver å få tilgang til en privat lenke. Vennligst logg inn først. ",
