OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Kon het wachtwoord niet herstellen, omdat het token ongeldig is ",
    "Could not reset password because the token expired" : "Kon het wachtwoord niet herstellen, omdat het token verlopen is ",
    "Could not reset password because the token does not match" : "Kon het wachtwoord niet resetten omdat het token niet overeenkomt",
    ...
    "Recipients can view, download and upload contents." : "Ontvangers kunnen bestanden bekijken, downloaden en uploaden",
