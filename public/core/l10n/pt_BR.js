OC.L10N.register(
    ...
    "Could not reset password because the token expired" : "Não foi possível redefinir a senha porque o token expirou",
    "Could not reset password because the token does not match" : "Não foi possível redefinir a senha porque o token não corresponde",
    ...
    "Recipients can view, download and upload contents." : "Os destinatários podem visualizar, baixar e fazer upload de conteúdo.",
    "Download / View / Edit" : "Baixar / Ver / Editar",
    "Recipients can view, download, edit, delete and upload contents." : "Os destinatários podem visualizar, baixar, editar, excluir e enviar conteúdos.",
    ...
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "Você ativou um ou mais aplicativos ownCloud Enterprise, mas sua instalação ainda não possui uma licença válida.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Um período de carência de 24 horas foi iniciado para permitir que você comece imediatamente. Quando o período de carência terminar, todos os aplicativos corporativos serão desativados, a menos que você forneça uma chave de licença válida.",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Para experimentar o ownCloud Enterprise, basta iniciar uma demonstração de 30 dias e digite a chave de licença fornecida abaixo.",
    "Upgrade to ownCloud Enterprise" : "Atualize para ownCloud Enterprise",
    "Remaining time: {rtime}" : "Tempo restante: {rtime}",
    "Get your demo key" : "Obtenha sua chave de demonstração",
    "Enter license key" : "Insira chave da licença",
    "Set new key" : "Definir nova chave",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Você está executando no modo DEBUG, isso pode causar efeitos colaterais indesejados. Remova o sinalizador \"debug\" do \"config.php\".",
    ...
    "Anyone with the link has access to the file/folder" : "Qualquer pessoa com o link tem acesso ao arquivo/pasta",
    "Copied!" : "Copiado!",
    ...
    "Link name" : "Nome do linque",
    "Name" : "Nome",
    "Filename" : "Nome do Arquivo",
    "Password" : "Senha",
    "Can not remove required password" : "Não é possível remover a senha requisitada",
    ...
    "An error occurred while sending email" : "Um erro ocorreu enquanto enviava o email",
    ...
    "Email notification not sent" : "Notificação de e-mail não enviada",
    ...
    "Unknown Share" : "Compartilhamento Desconhecido",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Mais detalhes podem ser encontrado no <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">log do servidor</a>.",
    ...
    "Hey there,<br><br>just letting you know that %s shared <strong>%s</strong> with you.<br><a href=\"%s\">View it!</a><br><br>" : "Olá,<br><br>Só para você saber que %s compartilhou <strong>%s</strong> com você. <br><a href=\"%s\">Visualize-o!</a><br><br> ",
    ...
    "You took too long to log in, please try again now" : "Você demorou muito para fazer login, tente novamente agora",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Entre em contato com o administrador. Se você é um administrador desta instância, configure a opção \"trusted_domains\" em config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Uma configuração de exemplo é fornecida em config/config.sample.php ou em <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentação</a>.",
