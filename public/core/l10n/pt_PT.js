OC.L10N.register(
    ...
    "Expiration date is required" : "A data de expiração é necessária",
    "Delete {link}" : "Apagar {link}",
    "Remove link" : "Remover hiperligação",
    "Link" : "Hiperligação",
    "Create public link" : "Criar ligação pública",
    "Edit" : "Editar",
    "Remove" : "Remover",
    "Copy to clipboard" : "Copiar para a área de trânsferencia",
    "Social share" : "Partilha social",
    "There are currently no link shares, you can create one" : "Atualmente não existem partilhas por hiperligação, porém, pode criar uma",
    "Anyone with the link has access to the file/folder" : "Qualquer pessoa com a hiperligação terá acesso ao ficheiro/pasta",
    "Copied!" : "Copiado!",
    ...
    "Send link via email" : "Enviar hiperligação via correio eletrónico",
    "Sending" : "A Enviar",
    ...
    "User" : "Utilizador",
    "Group" : "Grupo",
    "User and Groups" : "Utilizador e Grupos",
    "Public Links" : "Ligações públicas",
    ...
    "Please specify the port number along with the host name (e.g., localhost: 5432)." : "Por favor, especifique o número da porta com o nome do anfitrião (exemplo, localhost: 5432).",
