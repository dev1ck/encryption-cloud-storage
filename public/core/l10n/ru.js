OC.L10N.register(
    ...
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "Вы включили одно или несколько приложений ownCloud для Enterprise, но у вашей установки ещё нет допустимого лицензионного ключа.",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "Запущен дополнительный период на 24 часа, чтобы вы смогли продвинуться дальше. Как только дополнительный период закончится, все приложения для Enterprise будут отключны, если вы не введёте допустимый лицензионный ключ.",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "Чтобы попробовать ownCloud Enterprise, просто запустите 30-дневную демонстрацию и введите ниже предоставленный лицензионный ключ.",
    "Upgrade to ownCloud Enterprise" : "Обновление ownCloud до Enterprise",
    "Remaining time: {rtime}" : "Остающееся время: {rtime}",
    "Get your demo key" : "Получить демонстрационный ключ",
    "Enter license key" : "Ввод лицензионного ключа",
    "Set new key" : "Установить новый ключ",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "Вы работаете в ОТЛАДОЧНОМ режиме, и это может давать нежелательные побочные эффекты. Пожалуйста уберите флаг «debug» из «config.php».",
    ...
    "An error occurred while sending email" : "При отправке письма произошла ошибка.",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Пожалуйста введите хотя бы {chars} символ для вывода предложений","Пожалуйста введите хотя бы {chars} символа для вывода предложений","Пожалуйста введите хотя бы {chars} символов для вывода предложений","Пожалуйста введите хотя бы {chars} символов для вывода предложений"],
    ...
    "Personal note from the sender: \n %s." : "Личная заметка от отправителя: \n %s.",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Дополнительные подробности можно найти в <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">журнале сервера</a>.",
    ...
    "You took too long to log in, please try again now" : "Похоже, вы потратили на вход слишком много времени, пожалуйста попробуйте ещё раз сейчас",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Пожалуйста, обратитесь к вашему администратору. Если вы являетесь администратором этого экземпляра, то настройте параметр «trusted_domains» в config/config.php.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Пример настройки имеется в config/config.sample.php или в <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">документации</a>.",
