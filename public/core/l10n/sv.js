OC.L10N.register(
    ...
    "Remaining time: {rtime}" : "Återstående tid: {rtime}",
    ...
    "You are trying to access a private link. Please log in first." : "Du försöker komma åt en privat länk. Vänligen logga in först.",
