OC.L10N.register(
    ...
    "Download / View / Upload" : "ดาวน์โหลด ดู หรืออัปโหลด",
    ...
    "Recipients can view, download, edit, delete and upload contents." : "ผู้รับสามารถดู ดาวน์โหลด แก้ไข ลบและอัปโหลดเนื้อหา",
    "Upload only" : "อัปโหลดเท่านั้น",
    "Receive files from multiple recipients without revealing the contents of the folder." : "รับไฟล์จากผู้รับโดยไม่ต้องเปิดเผยเนื้อหาของโฟลเดอร์",
    "Preparing update" : "เตรียมอัปเดต",
    "[%d / %d]: %s" : "[%d / %d]: %s",
    "Repair warning: " : "เตือนการซ่อมแซม:",
    "Repair error: " : "เกิดข้อผิดพลาดในการซ่อมแซม:",
    "Please use the command line updater because automatic updating is disabled in the config.php." : "กรุณาใช้คำสั่งอัปเดตเพราะการอัปเดตอัตโนมัติถูกปิดใช้งานใน config.php",
    ...
    "Updating database schema" : "กำลังอัปเดตฐานข้อมูล schema",
    "Updated database" : "อัปเดตฐานข้อมูลเรียบร้อยแล้ว",
    "Checking whether the database schema can be updated (this can take a long time depending on the database size)" : "กำลังตรวจสอบว่าฐานข้อมูล schema สามารถอัปเดตได้หรือไม่ (นี้อาจใช้เวลานานขึ้นอยู่กับขนาดของฐานข้อมูล)",
    "Checked database schema update" : "Schema อัปเดตของฐานข้อมูลถูกตรวจสอบ",
    "Checking updates of apps" : "กำลังตรวจสอบการอัปเดตแอปพลิเคชัน",
    "Checking whether the database schema for %s can be updated (this can take a long time depending on the database size)" : "กำลังตรวจสอบว่าฐานข้อมูลสำหรับ schema สำหรับ %s ว่าสามารถอัปเดตได้หรือไม่ (นี้จะใช้เวลานานขึ้นอยู่กับขนาดของฐานข้อมูล)",
    "Checked database schema update for apps" : "Schema อัปเดตของฐานข้อมูลสำหรับแอปฯ",
    "Updated \"%s\" to %s" : "อัปเดต \"%s\" ไปยัง %s",
    ...
    "Following apps have been disabled: %s" : "แอปฯดังต่อไปนี้ถูกปิดการใช้งาน: %s",
    ...
    "Nov." : "พ.ย.",
    "Dec." : "ธ.ค.",
    "<a href=\"{docUrl}\">There were problems with the code integrity check. More information…</a>" : "<a href=\"{docUrl}\">พบปัญหาเกี่ยวกับความปลอดภัยและการติดตั้ง ดูรายละเอียดเพิ่มเติม...</a>",
    "Settings" : "ตั้งค่า",
    "Problem loading page, reloading in 5 seconds" : "เกิดปัญหาขณะโหลดหน้าเว็บ จะรีโหลดหน้าเว็บภายใน 5 วินาที",
    "Saving..." : "กำลังบันทึกข้อมูล...",
    "Dismiss" : "ยกเลิก",
    "seconds ago" : "ไม่กี่วินาทีก่อนหน้านี้",
    "You have enabled one or more ownCloud Enterprise apps but your installation does not have a valid license yet." : "คุณได้มีการเปิดใช้งานแอป ownCloud Enterprise มากกว่าหนึ่งแอป โดยที่การติดตั้งของคุณยังไม่มีใบอนุญาตที่ถูกต้อง",
    "A grace period of 24 hours has started to allow you to get going right away. Once the grace period ends, all Enterprise apps will become disabled unless you supply a valid license key." : "เริ่มต้นการทดสอบการใช้งานแอปแบบ Enterprise โดยมีกำหนดระยะเวลา 24 ชั่วโมง หลักจากครบกำหนดแอป Enterprise ทั้งหมดจะถูกปิดการใช้งานเว้นแต่คุณจะกรอก License key เพื่อใช้งานต่อ",
    "To try ownCloud Enterprise, just start a 30-day demo and enter the provided license key below." : "เริ่มทดลองใช้ ownCloud แบบ Enterprise 30 วัน กรุณาป้อน License key ลงในช่องด้านล่าง",
    ...
    "This server has no working Internet connection. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "เซิร์ฟเวอร์นี้ไม่มีการเชื่อมต่ออินเทอร์เน็ตซึ่งหมายความว่าคุณสมบัติบางส่วน เช่น การจัดเก็บข้อมูลภายนอก การแจ้งเตือนเกี่ยวกับการอัปเดตหรือ การติดตั้งแอปพลิเคชันของบุคคลที่สาม การเข้าถึงไฟล์รีโมทและการส่งอีเมลแจ้งเตือนอาจจะไม่ทำงาน เราขอแนะนำให้เปิดใช้งานการเชื่อมต่ออินเทอร์เน็ตสำหรับเซิร์ฟเวอร์นี้ถ้าคุณต้องการใช้งานคุณสมบัติทั้งหมด",
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "ไม่มีการกำหนดค่าหน่วยความจำแคช (memcache) ข้อดีคือช่วยเพิ่มประสิทธิภาพการทำงาน สำหรับข้อมูลเพิ่มเติมสามารถดูได้จาก\n<a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">เอกสาร</a>",
    "/dev/urandom is not readable by PHP which is highly discouraged for security reasons. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "PHP ไม่สามารถอ่าน /dev/urandom เนื่องจากเหตุผลด้านความปลอดภัย สำหรับข้อมูลเพิ่มเติมสามารถดูได้จาก <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">เอกสาร</a>",
    "You are currently running PHP {version}. We encourage you to upgrade your PHP version to take advantage of <a target=\"_blank\" rel=\"noreferrer\" href=\"{phpLink}\">performance and security updates provided by the PHP Group</a> as soon as your distribution supports it." : "ขณะนี้คุณกำลังใช้ PHP เวอร์ชัน {version} เราขอให้คุณอัปเดต <a target=\"_blank\" rel=\"noreferrer\" href=\"{phpLink}\">เพื่อเหตุผลด้านประสิทธิภาพและความปลอดภัยของ PHP</a> ทันทีที่ระบบของคุณได้รับการสนับสนุน",
    ...
    "You are running in DEBUG mode, this can cause unwanted side effects. Please remove the \"debug\" flag from \"config.php\"." : "คุณกำลังทำงานในโหมดดีบัก มันอาจมีผลกระทบบางอย่าง โปรดนำ \"debug\" ออกจาก \"config.php\"",
    ...
    "You are accessing this site via HTTP. We strongly suggest you configure your server to require using HTTPS instead as described in our <a href=\"{docUrl}\">security tips</a>." : "คุณกำลังใช้งานเว็บไซต์นี้ผ่านช่องทาง HTTP เราขอแนะนำให้คุณใช้ HTTPS แทนตามที่อธิบายไว้ใน <a href=\"{docUrl}\">เคล็ดลับการรักษาความปลอดภัย</a> ",
    "Shared" : "แชร์แล้ว",
    ...
    "Edit" : "แก้ไข",
    "Remove" : "ลบออก",
    "Copy to clipboard" : "คัดลอกลิงก์ไปยังคลิปบอร์ด",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["โปรดป้อนอย่างน้อย {chars} ตัวอักษรเพื่อดูคำแนะนำ"],
    ...
    "Sharing is not allowed" : "ไม่อนุญาตให้แชร์ต่อ",
    "Share with people on other ownClouds using the syntax username@example.com/owncloud" : "แชร์กับผู้คนใน ownClouds อื่นๆ ที่ใช้งานในรูปแบบ username@example.com/owncloud",
    "Share with users…" : "แชร์กับผู้ใช้ ...",
    "Share with users, groups or remote users…" : "แชร์กับผู้ใช้ หรือกลุ่ม หรือผู้ใช้แบบรีโมท...",
    ...
    "Unknown Share" : "การแชร์ที่ไม่รู้จัก",
    ...
    "The upgrade is in progress, leaving this page might interrupt the process in some environments." : "กำลังดำเนินการอัปเกรด หากออกจากหน้านี้ ณ เวลานี้อาจเกิดปัญหาในภายหลัง",
    "Updating to {version}" : "กำลังอัปเดตเป็นเวอร์ชัน {version}",
    "An error occurred." : "เกิดข้อผิดพลาด",
    "Please reload the page." : "โปรดโหลดหน้าเว็บใหม่",
    "The update was unsuccessful. For more information <a href=\"{url}\">check our forum post</a> covering this issue." : "อัปเดตไม่สำเร็จ สำหรับข้อมูลเพิ่มเติมหาอ่านได้จาก <a href=\"{url}\">ตรวจสอบโพสต์ในฟอรั่มของเรา</a> เพื่อแก้ไขปัญหานี้",
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">ownCloud community</a>." : "การอัปเดตไม่เป็นผลสำเร็จ กรุณาแจ้งปัญหาที่เกิดขึ้นไปยัง <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">คอมมูนิตี้ผู้ใช้งาน ownCloud</a>",
    "The update was successful. There were warnings." : "การอัปเดตสำเร็จ แต่มีคำเตือนอยู่",
    "The update was successful. Redirecting you to ownCloud now." : "การอัปเดตเสร็จเรียบร้อย กำลังเปลี่ยนเส้นทางไปที่ ownCloud อยู่ในขณะนี้",
    ...
    "You took too long to log in, please try again now" : "คุณใช้เวลาในการลงชื่อเข้าใช้นานเกินไปโปรดลองอีกครั้งตอนนี้",
    ...
    "Use the following link to reset your password: {link}" : "ใช้ลิงก์ต่อไปนี้เพื่อเปลี่ยนรหัสผ่านใหม่ของคุณ: {link}",
    ...
    "Thank you for your patience." : "ขอบคุณสำหรับความคิดเห็น เราจะนำความคิดเห็นของท่านมาอัปเดตระบบให้ดียิ่งขึ้น",
    "Two-step verification" : "การยืนยันแบบสองขั้นตอน",
    "Enhanced security has been enabled for your account. Please authenticate using a second factor." : "ความปลอดภัยขั้นสูงได้ถูกเปิดใช้งานกับบัญชีของคุณ กรุณาตรวจสอบการยืนยันสองขั้นตอน",
    ...
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "โปรดติดต่อผู้ดูแลระบบของคุณ ถ้าคุณเป็นผู้ดูแลระบบของอินสแตนซ์นี้ให้กำหนดการตั้งค่า \"trusted_domains\" ใน config/config.php",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "ตัวอย่างการกำหนดค่าสามารถดูได้ที่  config/config.sample.php หรือที่ <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">เอกสาร</a>",
    "App update required" : "จำเป็นต้องอัปเดตแอปฯ",
    "%s will be updated to version %s" : "%s จะถูกอัปเดตเป็นเวอร์ชัน %s",
    "These apps will be updated:" : "แอปพลิเคชันเหล่านี้จะถูกอัปเดต:",
    ...
    "Detailed logs" : "รายละเอียดข้อมูล log",
    "Update needed" : "การปรับปรุงที่จำเป็น",
    "It looks like your instance may host many files and/or users. To ensure a smooth upgrade process, please use the command line updater (occ upgrade)." : "ดูเหมือนว่าอินสแตนซ์ของคุณอาจมีโฮสต์ ไฟล์หรือผู้ใช้จำนวนมากเพื่อให้แน่ใจว่ากระบวนการอัปเกรดทำงานได้ปกติดี โปรดใช้คำสั่งอัปเดต (occ upgrade)",
    "Automatic updating is disabled in config.php. To upgrade your instance, please use the command line updater (occ upgrade)." : "การอัปเดตโดยอัตโนมัติถูกปิดใช้งานใน config.php เพื่ออัปเกรดอินสแตนซ์ของคุณโปรดใช้คำสั่งอัปเดต (occ upgrade)",
