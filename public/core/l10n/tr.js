OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Belirteç geçersiz olduğundan parola sıfırlanamadı",
    "Could not reset password because the token expired" : "Belirteçin süresi dolduğu için parola sıfırlanamadı",
    "Could not reset password because the token does not match" : "Belirteç eşleşmediği için parola sıfırlanamadı ",
    ...
    "Recipients can view or download contents." : "Alıcılar içeriği görüntüleyebilir ve indirebilir",
    "Download / View / Upload" : "İndir / Görüntüle / Karşı tarafa yükle",
    "Recipients can view, download and upload contents." : "Alıcılar içeriği görüntüleyebilir, indirebilir ve karşı tarafa yükleyebilir.",
    "Download / View / Edit" : "İndir / Görüntüle / Düzenle",
    ...
    "Receive files from multiple recipients without revealing the contents of the folder." : "Klasörün içeriğini göstermeden birden çok alıcıdan dosya alın.",
    ...
    "Settings" : "Ayarlar",
    "Problem loading page, reloading in 5 seconds" : "Sayfa yüklemesinde hata, 5 saniye içinde yeniden yüklenecek",
    "Saving..." : "Kaydediliyor...",
    "Dismiss" : "İptal et",
    ...
    "The \"Strict-Transport-Security\" HTTP header is not configured to at least \"{seconds}\" seconds. For enhanced security we recommend enabling HSTS as described in our <a href=\"{docUrl}\" rel=\"noreferrer\">security tips</a>." : "\"Strict-Transport-Security\" HTTP başlığı en az \"{seconds}\" saniye olarak ayarlanmış. İyileştirilmiş güvenlik için <a href=\"{docUrl}\" rel=\"noreferrer\">güvenlik ipuçlarımızda</a> belirtilen HSTS etkinleştirmesini öneririz.",
    ...
    "Delete {link}" : "Sil {link}",
    "Remove link" : "Bağlantıyı sil",
    "Link" : "Bağlantı",
    ...
    "Anyone with the link has access to the file/folder" : "Bağlantya sahip herkes bu dosya/klasör'e erişebilir",
    "Copied!" : "Kopyalandı!",
    ...
    "Share to Twitter. Opens in a new window." : "Twitter'da paylaş. Yeni bir pencerede açılır",
    ...
    "Share via email. Opens your mail client." : "E-posta ile paylaş. E-posta istemcisinde açılır.",
    "Email link to person" : "Bağlantıyı e-posta ile gönder",
    "Send copy to self" : "Kendine kopyasını yolla",
    "Send link via email" : "Bağlantıyı e-posta ile gönder",
    "Add personal message" : "Kişisel mesaj ekle",
    ...
    "Email notification was sent!" : "E-posta bildirimi gönderildi!",
    "Email notification not sent" : "E-posta bildirimi gönderilemedi",
    ...
    "_Please enter at least {chars} character for suggestions_::_Please enter at least {chars} characters for suggestions_" : ["Lütfen öneriler için en az {chars} karakter girin","Lütfen öneriler için en az {chars} karakter girin"],
    ...
    "Sharing is not allowed" : "Paylaşma izinli değil",
    ...
    "Please contact the server administrator if this error reappears multiple times and include the technical details below in your report." : "Eğer bu hata birden çok kez oluştuysa, sunucu yöneticisine aşağıdaki teknik ayrıntılar ile birlikte iletişime geçin.",
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "Daha fazla ayrıntı <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">sunucu günlüğünde</a> bulunabilir.",
    ...
    "You are trying to access a private link. Please log in first." : "Özel bir bağlantıya erişmeye çalışıyorsunuz. Lütfen önce oturum açın.",
    ...
    "Personal note from the sender: <br> %s." : "Göndericiden kişisel mesaj: <br> %s.",
    ...
    "An error occurred while verifying the token" : "Belirteç onaylanırken bir hata oluştu",
    "You are accessing the server from an untrusted domain." : "Sunucuya güvenilmeyen bir alan adından ulaşıyorsunuz.",
    "Please contact your administrator. If you are an administrator of this instance, configure the \"trusted_domains\" setting in config/config.php. " : "Lütfen yöneticiniz ile iletişime geçin. Eğer bu örneğin bir yöneticisi iseniz, config/config.php dosyası içerisindeki \"trusted_domain\" ayarını yapılandırın.",
    "An example configuration is provided in config/config.sample.php or at the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation</a>." : "Örnek bir yapılandırma config/config.sample.php dosyasında veya <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">belgelerde</a> sağlanmıştır.",
