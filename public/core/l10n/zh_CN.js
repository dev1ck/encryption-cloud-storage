OC.L10N.register(
    ...
    "Download / View" : "下载 / 查看",
    "Recipients can view or download contents." : "接收者可查看或下载内容。",
    "Download / View / Upload" : "下载 / 查看 / 上传",
    "Recipients can view, download and upload contents." : "接收者可查看、下载以及上传内容。",
    "Download / View / Edit" : "下载 / 查看 / 编辑",
    "Recipients can view, download, edit, delete and upload contents." : "接收者可查看、下载、编辑、删除以及上传内容。",
    "Upload only" : "仅上传",
    "Receive files from multiple recipients without revealing the contents of the folder." : "从多个接收者处接收文件而不暴露文件夹中的内容。",
    ...
    "Error adding {addItem}: {addItem} already exists" : "添加{addItem}时发生错误：{addItem}已经存在",
    "No" : "否",
    "Yes" : "是",
    "Choose" : "选择",
    ...
    "Expiration" : "过期",
    "Choose an expiration date" : "选择过期日期",
    ...
    "Send copy to self" : "发送副本给自己。",
    "Send link via email" : "通过邮件发送链接",
    "Add personal message" : "增加个人信息",
    "Sending" : "发送中",
    "E-Mail sent" : "邮件已发送",
    ...
    "More details can be found in the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server log</a>." : "更多细节可在 <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">服务器日志</a>找到。",
