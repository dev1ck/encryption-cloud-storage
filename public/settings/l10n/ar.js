OC.L10N.register(
    ...
    "This app is not checked for security issues and is new or known to be unstable. Install at your own risk." : "لم يتم فحص هذا التطبيق للتأكد من عدم وجود مشكلات أمنية، فهو جديد أو معروف أنه غير ثابت. ثبِّته على مسؤوليتك الخاصة.",
    ...
    "An error occurred. Please upload an ASCII-encoded PEM certificate." : "حدث خطأ ما. يُرجى تحميل شهادة PEM المرمَّزة بـ ASCII.",
    ...
    "deleted {groupName}" : "{groupName} محذوف",
    "undo" : "تراجع",
    ...
    "Set default expiration date for remote shares" : "تعيين تاريخ انتهاء الصلاحية الافتراضي للمشاركات البعيدة",
    ...
    "Enable manual file locking on clients" : "تفعيل قفل الملفات يدويًا على العملاء",
    ...
    "Your database does not run with \"READ COMMITED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "لا تعمل قاعدة بياناتك مع مستوى عزل المعاملة \"READ COMMITED\". ويؤدي ذلك إلى حدوث مشكلات عند تنفيذ إجراءات متعددة في الوقت نفسه.",
    ...
    "Please set your password" : "يُرجى تعيين كلمة المرور الخاصة بك",
    "Personal" : "شخصي",
    "Admin" : "المسؤول",
    "Currently no settings are available in this category" : "لا تتوفر أي إعدادات حاليًا في هذه الفئة",
    "The administrators can enable additional apps which add settings sections here." : "يمكن أن يمكِّن المسؤولون التطبيقات الإضافية التي تضيف أقسام الإعدادات هنا.",
    ...
    "Settings" : "الإعدادات",
    "Show enabled/disabled option" : "عرض الخيار المُمكَّن/المُعطَّل",
