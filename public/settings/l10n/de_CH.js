OC.L10N.register(
    ...
    "Saved" : "Gespeichert",
    "log-level out of allowed range" : "Log-Level ausserhalb des erlaubten Bereichs",
    ...
    "This app is not checked for security issues and is new or known to be unstable. Install at your own risk." : "Diese App ist nicht auf Sicherheitsprobleme hin überprüft und ist neu oder bekanntermassen instabil. Die Installation erfolgt auf eigenes Risiko.",
    ...
    "Are you sure you want to remove this domain?" : "Soll diese Domain wirklich entfernt werden?",
    "CORS" : "KERNE",
    "Sending..." : "Senden…",
    "Failed to change the email address." : "Fehler beim Ändern der E-Mail-Adresse.",
    "Email changed successfully for {user}." : "E-Mail erfolgreich für {user} geändert.",
    ...
    "Be aware that encryption always increases the file size." : "Sei dir bewusst, dass die Verschlüsselung immer die Dateigrösse erhöht.",
    "It is always good to create regular backups of your data, in case of encryption make sure to backup the encryption keys along with your data." : "Es ist immer gut, regelmässig Sicherungskopien von deinen Daten zu machen. Falls du die Verschlüsselung nutzt, solltest du auch eine Sicherung der Verschlüsselungsschlüssel zusammen mit deinen Daten machen.",
    ...
    "No encryption module loaded, please enable an encryption module in the app menu." : "Kein Verschlüsselungs-Modul geladen, bitte aktiviere ein Verschlüsselungs-Modul im Anwendungs-Menü (Apps).",
    ...
    "Enforce password protection for read-only links" : "Passwort für \"nur lesen\" Links erzwingen ",
    "Enforce password protection for read + write links" : "Passwort für \"lesen+schreiben\" Links erzwingen",
    "Enforce password protection for read + write + delete links" : "Passwort für \"lesen+schreiben+löschen\" Links erzwingen",
    "Enforce password protection for upload-only (File Drop) links" : "Passwort für Upload-Links (File Drop) erzwingen",
    "Set default expiration date" : "Standardmässiges Ablaufdatum setzen",
    ...
    "Set default expiration date for user shares" : "Standardmässiges Ablaufdatum für Nutzer-Freigaben setzen",
    "Set default expiration date for group shares" : "Standardmässiges Ablaufdatum für Gruppen-Freigaben setzen",
    ...
    "Exclude groups from sharing" : "Gruppen von Freigaben ausschliessen",
    ...
    "Privacy Policy URL" : "Datenschutz-URL",
    "Enterprise license key" : "Enterprise-Lizenzschlüssel",
    "Enter a new license:" : "Neue Lizenz eingeben:",
    "Save" : "Speichern",
    ...
    "The config file is read only. Please adjust your setup by editing the config file manually." : "Die Konfigurationsdatei ist schreibgeschützt. Bitte passe deine Einstellungen durch manuelle Bearbeitung der Konfigurationsdatei selbst an.",
    "In a clustered setup please make sure to sync the config.php file across all nodes." : "In einem gruppierten Umgebung stelle bitte sicher, dass die config.php-Datei über alle Knoten synchronisiert wird.",
    ...
    "Manual File Locking" : "Manuelles Sperren von Dateien",
    "Default timeout for the locks if not specified (in seconds)" : "Standard-Timeout für die Sperre, falls nicht angegeben (in Sekunden)",
    "Maximum timeout for the locks (in seconds)" : "Maximaler-Timeout für die Sperre von Dateien",
    "Enable manual file locking on clients" : "Manuelle Dateisperre auf Clients aktivieren",
    ...
    "SQLite is used as database. For larger installations we recommend to switch to a different database backend." : "SQLite wird als Datenbank verwendet. Bei grösseren Installationen wird empfohlen, auf ein anderes Datenbank-Backend zu wechseln.",
    ...
    "White-listed Domains" : "Weisse Liste der Domains",
    ...
    "Sessions" : "Sitzungen",
    "These are the web, desktop and mobile clients currently logged in to your %s." : "Diese Web-, Desktop- und Mobil-Anwendungen sind zur Zeit auf %s angemeldet",
    "Browser" : "Browser",
    ...
    "Name" : "Name",
    "App passwords or tokens are passcodes that give an app or device permissions to access your %s account." : "App-Passwörter oder Token sind passcodes, die einer App oder einem Gerät Zugriff auf dein %s Konto geben.",
    "Use them as a security measure to hide your actual password which you may only want to use for web interface login." : "Benutze diese als Sicherheitsmassnahme, um dein richtiges Passwort nur für den Webzugriff zu verwenden.",
    "App name" : "App-Name",
    ...
    "The administrators can enable additional apps which add settings sections here." : "Die Administratoren können Apps aktivieren, die dann zusätzliche Einstellungen hinzufügen.",
