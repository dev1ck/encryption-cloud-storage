OC.L10N.register(
    ...
    "Invalid url '%s'. Urls should be set up like 'http://www.example.com' or 'https://www.example.com'" : "Url invalide '%s'. Les Urls doivent être de la forme 'http://www.exemple.com' ou 'https://www.exemple.com'",
    ...
    "Enforce password protection for read-only links" : "Forcer la protection par mot de passe pour les liens en lecture seule",
    "Enforce password protection for read + write links" : "Forcer la protection par mot de passe pour les liens en écriture et lecture",
    ...
    "Extra field to display in autocomplete results" : "Champ supplémentaire à afficher dans les résultats de l'Auto-complétion",
    "None" : "Aucun",
    "User ID" : "ID utilisateur",
    "Email address" : "Adresse mail",
    "Imprint URL:" : "adresse d'Mentions légales : ",
    "Imprint URL" : "adresse d'Mentions légales",
    "Privacy Policy URL:" : "adresse de la Politique de confidentialité : ",
    "Privacy Policy URL" : "adresse de la Politique de confidentialité",
    "Save" : "Enregistrer",
    ...
    "Sessions" : "Sessions",
    "These are the web, desktop and mobile clients currently logged in to your %s." : "Voivi les clients Web, de bureau et mobiles actuellement connectés à votre %s.",
    "Browser" : "Navigateur",
    "Most recent activity" : "Activité la plus récente",
    "App passwords / tokens" : "mots de passe / jetons d'application",
    "You've linked these apps." : "Vous avez lié ces applications.",
    "Name" : "Nom",
    "App passwords or tokens are passcodes that give an app or device permissions to access your %s account." : "Les mots de passe d'application ou jetons sont des code d'accés qui donne à une application ou à un appareil les droits d'accès à votre compte %s.",
    "App name" : "Nom de l'application",
    "Create new app passcode" : "Créer un nouveau code de sécurité d'application",
    ...
    "Currently no settings are available in this category" : "Actuellement, aucun paramètre n'est disponible dans cette catégorie",
    "The administrators can enable additional apps which add settings sections here." : "Les administrateurs peuvent activer des applications supplémentaires qui ajoutent des rubriques de paramètres ici.",
