OC.L10N.register(
    ...
    "Please provide an admin recovery password; otherwise, all user data will be lost." : "Silakan buat sandi pemulihan admin; jika tidak, seluruh data pengguna akan hilang.",
    ...
    "installing and updating apps via the market or Federated Cloud Sharing" : "menginstal atau memperbaharui aplikasi melalui market atau Federated Cloud Sharing",
    ...
    "The token provided had expired." : "Token telah habis.",
    "Failed to create activation link. Please contact your administrator." : "Gagal membuat tautan aktivasi. Silakan hubungi administrator.",
    "Can't send email to the user. Contact your administrator." : "Surel tidak terkirim. Hubungi administrator.",
    "Failed to set password. Please contact the administrator." : "Gagal membuat sandi. Silakan hubungi administrator.",
    "Failed to set password. Please contact your administrator." : "Gagal membuat sandi. Silakan hubungi administrator.",
    "Failed to send email. Please contact your administrator." : "Gagal mengirim surel. Silakan hubungi administrator.",
    ...
    "undo" : "urungkan",
    "You are about to delete a group. This action can't be undone and is permanent. Are you sure that you want to permanently delete {groupName}?" : "Anda akan menghapus grup. Tindakan ini tidak dapat diulangi dan permanen. Anda yakin ingin tetap menghapus {groupName}?",
    ...
    "User {uid} has been {state}!" : "Pengguna {uid} telah {state}!",
    "no group" : "tanpa grup",
    ...
    "Password successfully changed" : "Sandi berhasil diganti",
    "A valid username must be provided" : "Harus memberikan nama pengguna yang benar",
    "Error creating user: {message}" : "Gagal menambahkan pengguna: {message}",
