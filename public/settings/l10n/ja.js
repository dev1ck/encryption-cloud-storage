OC.L10N.register(
    ...
    "installing and updating apps via the market or Federated Cloud Sharing" : "アプリストアまたはクラウド連携共有からアプリをインストール/アップデート",
    ...
    "Empty app name is not allowed." : "空のアプリ名は許可されていません。",
    "Error while creating device token" : "デバイストークンの作成におけるエラー",
    "Error while deleting the token" : "トークンの削除におけるエラー",
    "Are you sure you want to remove this domain?" : "このドメインを削除しますか？",
    "CORS" : "CORS",
    "Sending..." : "送信中…",
    "Failed to change the email address." : "メールアドレスの変更に失敗しました。",
    "Email changed successfully for {user}." : "{user}のメールアドレスが正常に変更されました。",
    ...
    "Enforce password protection for read-only links" : "読取専用のリンクにパスワードによる保護を強制する",
    "Enforce password protection for upload-only (File Drop) links" : "アップロード（File Drop）のみのリンクにパスワードによる保護を強制する",
    ...
    "Restrict users to only share with groups they are member of" : "ユーザーの所属するグループのメンバーのみと共有可能とする",
    ...
    "Restrict enumeration to group members" : "グループのメンバーのみ列挙する",
    "Extra field to display in autocomplete results" : "オートコンプリートの結果に表示する追加のフィールド",
    "None" : "なし",
    "User ID" : "ユーザーID",
    ...
    "The config file is read only. Please adjust your setup by editing the config file manually." : "設定ファイルが読取専用です。設定ファイルを手で編集してセットアップを調整してください。",
    "In a clustered setup please make sure to sync the config.php file across all nodes." : "クラスタ化されたセットアップでは全てのノードでconfig.phpを確実に同期してください。",
    ...
    "iOS app" : "iOSアプリ",
    "If you want to support the project\n\t\t\t<a href=\"https://owncloud.org/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">join development</a>\n\t\t\tor\n\t\t\t<a href=\"https://owncloud.org/promote\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">spread the word</a>!" : "このプロジェクトをサポートするには<a href=\"https://owncloud.org/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">開発に参加する</a>か<a href=\"https://owncloud.org/promote\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">世界に広めて</a>ください！",
    "Show First Run Wizard again" : "初回ウィザードを再表示する",
    "No Domains." : "ドメインがありません。",
    "Domain" : "ドメイン",
    "Add Domain" : "ドメインを追加する",
    "Add" : "追加",
    ...
    "You are not a member of any groups." : "あなたはどのグループのメンバーでもありません。",
    "Password" : "パスワード",
    ...
    "You are using %s" : "%s使用中",
    "You are using %s of %s (%s %%)" : "%s/%s使用中（%s%%）",
