OC.L10N.register(
    ...
    "Your database does not run with \"READ COMMITED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "데이터베이스가 \"READ COMMITED\" 트랜잭션 격리 단계로 실행 중이 아닙니다. 여러 작업을 병렬로 실행할 때 문제가 발생할 수 있습니다.",
    ...
    "Transactional file locking should be configured to use memory-based locking, not the default slow database-based locking. See the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">documentation ↗</a> for more information." : "트랜잭션 파일 잠금이 기본값인 느린 데이터베이스 기반 잠금이 아닌 메모리 기반 잠금을 사용하도록 설정되어야 합니다. 더 많은 정보를 보려면 <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">문서 ↗</a>를 참조하십시오.",
    ...
    "Please double check the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">installation guides ↗</a>, and check for any errors or warnings in the <a href=\"#log-section\">log</a>." : "<a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">설치 가이드 ↗</a>를 확인하고 <a href=\"#log-section\">로그</a>의 오류 또는 경고를 확인하십시오.",
    ...
    "iOS app" : "iOS 앱",
    "If you want to support the project\n\t\t\t<a href=\"https://owncloud.org/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">join development</a>\n\t\t\tor\n\t\t\t<a href=\"https://owncloud.org/promote\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">spread the word</a>!" : "이 프로젝트를 지원하려면\n\t\t\t<a href=\"https://owncloud.org/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">개발에 참여</a>\n\t\t\t하거나\n\t\t\t<a href=\"https://owncloud.org/promote\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">주변에 알려 주세요</a>!",
    ...
    "App passwords / tokens" : "앱 암호 / 토큰",
    "You've linked these apps." : "다음 앱을 연결했습니다.",
    "Name" : "이름",
    "App name" : "앱 이름",
    "Create new app passcode" : "새로운 앱 패스코드 생성",
