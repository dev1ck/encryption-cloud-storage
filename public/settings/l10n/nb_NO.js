OC.L10N.register(
    ...
    "installing and updating apps via the market or Federated Cloud Sharing" : "installering og oppdatering av apper via markedet eller ved deling i Forent sky",
    ...
    "CORS" : "CORS",
    "Sending..." : "Sender...",
    "Failed to change the email address." : "Klarte ikke å endre epost-adressen.",
    ...
    "undo" : "angre",
    "You are about to delete a group. This action can't be undone and is permanent. Are you sure that you want to permanently delete {groupName}?" : "Du er i ferd med å slette en gruppe. Denne handlingen kan ikke gjøres om og er permanent. Er du sikker på at du vil permanent slette {groupName}?",
    "Delete group" : "Slett gruppe",
    "never" : "aldri",
    "deleted {userName}" : "slettet {userName}",
    "You are about to delete a user. This action can't be undone and is permanent. All user data, files and shares will be deleted. Are you sure that you want to permanently delete {userName}?" : "Du er i ferd med å slette en bruker. Denne handlingen kan ikke gjøres om og er permanent. Alle brukerdata, filer og delt innhold vil bli slettet. Er du sikker på at du vil permanent slette {userName}?",
    ...
    "Language" : "Språk",
    "Apps Management" : "App-administrering",
    ...
    "Show enabled apps" : "Vis aktiverte apper",
    "Show disabled apps" : "Vis deaktiverte apper",
    "Cron" : "Cron",
    ...
    "Restrict users to only share with groups they are member of" : "Begrens brukerne til å bare dele med grupper de er medlem av",
    ...
    "Restrict enumeration to group members" : "Begrens opplisting til gruppemedlemmer",
    "Default user and group share permissions" : "Standard rettigheter ved deling med brukere og grupper",
    "Extra field to display in autocomplete results" : "Ekstra felt som skal vises i autofullføringsresultater",
    "None" : "Ingen",
    "User ID" : "User ID",
    ...
    "You are using %s of %s (%s %%)" : "Du bruker %s av %s (%s %%)",
