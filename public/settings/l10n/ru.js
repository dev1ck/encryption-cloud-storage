OC.L10N.register(
    ...
    "days" : "дней",
    "Enforce as maximum expiration date" : "Принудительно установить в качестве максимальной даты устаревания",
    ...
    "Privacy Policy URL" : "Адрес политики конфиденциальности",
    "Enterprise license key" : "Лицензионный ключ Enterprise",
    "Enter a new license:" : "Введите новую лицензию:",
    "Save" : "Сохранить",
    ...
    "Manual File Locking" : "Блокировка файла вручную",
    "Default timeout for the locks if not specified (in seconds)" : "Таймаут для блокировок по умолчанию, если не задано (в секундах)",
    "Maximum timeout for the locks (in seconds)" : "Максимальный таймаут для блокировок (в секундах)",
    "Enable manual file locking on clients" : "Разрешить ручную блокировку файлов на клиентах",
    ...
    "Currently no settings are available in this category" : "В этой категории сейчас нет доступных настроек",
    "The administrators can enable additional apps which add settings sections here." : "Администраторы могут включать дополнительные приложения, которые добавляют сюда настройки.",
