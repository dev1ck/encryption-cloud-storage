OC.L10N.register(
    ...
    "Invalid url '%s'. Urls should be set up like 'http://www.example.com' or 'https://www.example.com'" : "Url e pavlefshme '%s'. Url-të duhet të ujdisen si 'http://www.example.com' or 'https://www.example.com'",
    ...
    "Error while creating device token" : "Gabim gjatë krijimit të token-ëve të pajisjeve",
    ...
    "In a clustered setup please make sure to sync the config.php file across all nodes." : "Në një instalim kluster sigurohuni të njëkohësoni kartelën config.php në krejt nyjet.",
    ...
    "Performance tuning" : "Përimtime punimi",
    ...
    "Show quota field" : "Shfaq fushë kuotash",
    "E-Mail" : "Email",
    ...
    "Please enter storage quota (ex: \"512 MB\" or \"12 GB\")" : "Ju lutemi, jepni kuotë depozite (p.sh.: \"512 MB\" ose \"12 GB\")",
    "Unlimited" : "E pakufizuar",
    "Other" : "Tjetër",
    "Full Name" : "Emri i Plotë",
    "Group Admin for" : "Përgjegjës Grupi për",
    "Quota" : "Kuota",
