OC.L10N.register(
    ...
    "enabled" : "увімкнено",
    "disabled" : "вимкнено",
    "User {uid} has been {state}!" : "Користувач {uid} був {state}!",
    "no group" : "без групи",
    ...
    "Error creating user: {message}" : "Помилка при створенні користувача: {message}",
    ...
    "Set password for new users" : "Встановити пароль для нових користувачів",
